...
public class DungeonData {
  ...
  public static final String TYPE_RANDOM = "__RANDOM__"; // $NON-NLS-1$
  public static final String TYPE_CAVE = "__CAVE__"; // $NON-NLS-1$
  public static final String TYPE_ROOMS = "__ROOMS__"; // $NON-NLS-1$
  ...
  public void setLevel(short level) throws Exception {
    if (level <= 0) {
      throw new Exception(
          Messages.getString("DungeonData.3") + level + "]"); // $NON-NLS-1$ //$NON-NLS-2$
    }
