    ...
    for (int i = 0; i < item.getList().size(); i++) {
      if (item.getList().get(i).getName().equalsIgnoreCase(MapGeneratorItem.ITEM_CHANGE_SOURCE)) {
        source = item.getList().get(i).getValue();
          ...
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_CHANGE_DESTINATION)) {
        destination = item.getList().get(i).getValue();
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_CHANGE_TERRAIN)) {
        terrain = item.getList().get(i).getValue();
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_CHANGE_PCT)) {
        pct = Utils.getInteger(item.getList().get(i).getValue(), 0);
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_CHANGE_RADIUS)) {
        radius = Utils.getInteger(item.getList().get(i).getValue(), 1);
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_CHANGE_HEIGHT_MIN)) {
        iHeightMin = Utils.getInteger(item.getList().get(i).getValue(), -1);
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_CHANGE_HEIGHT_MAX)) {
