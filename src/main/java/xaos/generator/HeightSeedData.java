    ...
    for (int i = 0; i < item.getList().size(); i++) {
      if (item.getList().get(i).getName().equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_NUM)) {
        num = Utils.launchDice(item.getList().get(i).getValue());
          ...
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_TURNS)) {
        turns = Utils.launchDice(item.getList().get(i).getValue());
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_STARTING_POINT_ID)) {
        startingPointID = item.getList().get(i).getValue();
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_FLATS_BETWEEN_LEVELS)) {
        flatsBetweenLevels = Utils.launchDice(item.getList().get(i).getValue());
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_POINTX)) {
        pointx = item.getList().get(i).getValue();
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_POINTY)) {
        pointy = item.getList().get(i).getValue();
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_NORTHPCT)) {
        northPCT = Utils.launchDice(item.getList().get(i).getValue());
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_SOUTHPCT)) {
        southPCT = Utils.launchDice(item.getList().get(i).getValue());
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_EASTPCT)) {
        eastPCT = Utils.launchDice(item.getList().get(i).getValue());
      } else if (item.getList()
          .get(i)
          .getName()
          .equalsIgnoreCase(MapGeneratorItem.ITEM_HEIGHTSEED_WESTPCT)) {
