...
public class HeroPrerequisite implements Externalizable {
  ...
  public static final String STR_ID_MIN_CITIZENS = "minCitizens"; // $NON-NLS-1$
  public static final String STR_ID_MAX_CITIZENS = "maxCitizens"; // $NON-NLS-1$
  public static final String STR_ID_LEVEL_DISCOVERED = "levelDiscovered"; // $NON-NLS-1$
  public static final String STR_ID_FREE_ROOM = "freeRoom"; // $NON-NLS-1$
  public static final String STR_ID_FREE_ROOM_UNDERGROUND = "freeRoomUnderground"; // $NON-NLS-1$
  public static final String STR_ID_FREE_ROOM_HIGH = "freeRoomHigh"; // $NON-NLS-1$
  public static final String STR_ID_ZONE = "zone"; // $NON-NLS-1$
  public static final String STR_ID_FREE_ROOM_ITEMS = "freeRoomItems"; // $NON-NLS-1$

  public static final int ID_MIN_CITIZENS = 1;
  public static final int ID_MAX_CITIZENS = 2;
  public static final int ID_LEVEL_DISCOVERED = 3;
  public static final int ID_FREE_ROOM = 4;
  public static final int ID_FREE_ROOM_UNDERGROUND = 5;
  public static final int ID_FREE_ROOM_HIGH = 6;
  public static final int ID_ZONE = 7;
  public static final int ID_FREE_ROOM_ITEMS = 8;
  ...
  /**
   * Se le pasa una lista de prerequisitos (puede ser null o vacía) y un ID de prerequisito. Si ese prerequisito
   * existe en la lista lo devuelve, en otro caso devuelve null
   *
   * @param alPrerequisites
   * @param iPrerequisiteID
   * @return
   */
  public static HeroPrerequisite getHeroPrerequisite(
  ...
  public void setId(String sID) throws Exception {
    ...
    if (sID.equalsIgnoreCase(STR_ID_MIN_CITIZENS)) {
      ...
      throw new Exception(
          Messages.getString("HeroPrerequisite.1") + sID + "]"); // $NON-NLS-1$ //$NON-NLS-2$
    }
  }
  ...
  public void setValue(String sValue) throws Exception {
    ...
    switch (getId()) {
      ...
      default :
        throw new Exception(
            Messages.getString("HeroPrerequisite.2")
                + getStringID(getId())
                + "] ["
                + sValue
