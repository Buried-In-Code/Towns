...
public class QueueItem implements Externalizable {
  ...
  private static final String TYPE_STR_PICK = "pick"; // $NON-NLS-1$
  private static final String TYPE_STR_PICK_FRIENDLY = "pickFriendly"; // $NON-NLS-1$
  private static final String TYPE_STR_MOVE = "move"; // $NON-NLS-1$
  private static final String TYPE_STR_WAIT = "wait"; // $NON-NLS-1$
  private static final String TYPE_STR_DESTROY_ITEM = "destroyItem"; // $NON-NLS-1$
  private static final String TYPE_STR_DESTROY_CELL_ITEM = "destroyCellItem"; // $NON-NLS-1$
  private static final String TYPE_STR_DESTROY_FRIENDLY = "destroyFriendly"; // $NON-NLS-1$
  private static final String TYPE_STR_LOCK = "lock"; // $NON-NLS-1$
  private static final String TYPE_STR_UNLOCK = "unlock"; // $NON-NLS-1$
  private static final String TYPE_STR_CREATE_ITEM = "createItem"; // $NON-NLS-1$
  private static final String TYPE_STR_CREATE_ITEM_BY_TYPE = "createItemByType"; // $NON-NLS-1$
  private static final String TYPE_STR_CREATE_FRIENDLY = "createFriendly"; // $NON-NLS-1$
  private static final String TYPE_STR_REPLACE_CELL_ITEM = "replaceCellItem"; // $NON-NLS-1$
  private static final String TYPE_STR_CHANGE_TERRAIN = "changeTerrain"; // $NON-NLS-1$
  private static final String TYPE_STR_MOVE_TERRAIN = "moveTerrain"; // $NON-NLS-1$
  private static final String TYPE_STR_REVIVE_HEROES = "reviveHeroes"; // $NON-NLS-1$
  private static final String TYPE_STR_DELETE_COINS = "deleteCoins"; // $NON-NLS-1$
  private static final String TYPE_STR_DELETE_COINS_PCT = "deleteCoinsPCT"; // $NON-NLS-1$
  private static final String TYPE_STR_ADD_GOD_STATUS = "addGodStatus"; // $NON-NLS-1$

  public static final int TYPE_PICK = 1;
  public static final int TYPE_MOVE = 2;
  public static final int TYPE_WAIT = 3;
  public static final int TYPE_DESTROY_ITEM = 4;
  public static final int TYPE_UNLOCK = 5;
  public static final int TYPE_CREATE_ITEM = 6;
  public static final int TYPE_PLACE_ITEM = 7; // Código interno, lo usan los aldeanos
  public static final int TYPE_PICK_FRIENDLY = 8;
  public static final int TYPE_DESTROY_FRIENDLY = 9;
  public static final int TYPE_CREATE_FRIENDLY = 10;
  public static final int TYPE_DESTROY_CELL_ITEM = 11;
  public static final int TYPE_REPLACE_CELL_ITEM = 12;
  public static final int TYPE_CHANGE_TERRAIN = 13;
  public static final int TYPE_MOVE_TERRAIN = 14;
  public static final int TYPE_CREATE_ITEM_BY_TYPE = 15;
  public static final int TYPE_LOCK = 16;
  public static final int TYPE_REVIVE_HEROES = 17;
  public static final int TYPE_DELETE_COINS = 18;
  public static final int TYPE_DELETE_COINS_PCT = 19;
  public static final int TYPE_ADD_GOD_STATUS = 20;
  ...
  public void setFx(String fx) throws Exception {
    if (fx != null && !UtilsAL.exists(fx)) {
      throw new Exception(
          Messages.getString("QueueItem.1")
              + " ["
              + fx
  ...
  public void setType(String sType) throws Exception {
    ...
    if (sType.equalsIgnoreCase(TYPE_STR_PICK)) {
      ...
      throw new Exception(
          Messages.getString("QueueItem.6") + sType + "]"); // $NON-NLS-1$ //$NON-NLS-2$
    }
  }
    ...
    if (value != null) {
      if (getType() == TYPE_CREATE_ITEM) {
        if (ItemManager.getItem(value) == null) {
          throw new Exception(
              Messages.getString("QueueItem.0") + value + "]"); // $NON-NLS-1$ //$NON-NLS-2$
        }
      } else if (getType() == TYPE_MOVE
          || getType() == TYPE_PICK
          || getType() == TYPE_PICK_FRIENDLY
          || getType() == TYPE_LOCK) {
          ...
          for (int i = 0; i < alTokens.size(); i++) {
            if (getType() == TYPE_PICK || getType() == TYPE_MOVE || getType() == TYPE_LOCK) {
              if (ItemManager.getItem(alTokens.get(i)) == null) {
                throw new Exception(
                    Messages.getString("QueueItem.0")
                        + alTokens.get(i)
                        + "]"); //$NON-NLS-1$ //$NON-NLS-2$
              }
            } else {
