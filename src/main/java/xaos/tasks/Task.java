...
public final class Task implements Externalizable {
  ...
  // Tipos de tarea
  public static final int TASK_NO_TASK = 0; // Sin tarea
  public static final int TASK_DIG = 3; // Tarea de digar (mine abajo)
  public static final int TASK_MINE = 4; // Tarea de minar
  public static final int TASK_CANCEL_ORDER = 5; // Cancelar órden (mine/dig/chop)
  public static final int TASK_MINE_LADDER = 7; // Tarea de minar y poner escalera

  // Citizens
  public static final int TASK_WEAR = 10; // Tarea de equipar aldeano
  public static final int TASK_WEAR_OFF = 11; // Tarea de 'des'equipar aldeano
  public static final int TASK_CONVERT_TO_CIVILIAN = 12; // Tarea de convertir un soldado en civil
  public static final int TASK_CONVERT_TO_SOLDIER = 13; // Tarea de convertir un civil en soldado
  public static final int TASK_FIGHT = 14; // Tarea de luchar, sólo se asigna a soldados
  public static final int TASK_HEAL = 15; // Tarea de curarse
  public static final int TASK_AUTOEQUIP = 16; // Tarea de autoequiparse
  public static final int TASK_SOLDIER_SET_STATE = 17; // Tarea de cambiar el estado de un soldado (guard, boss
  // around, patrol)
  public static final int TASK_SOLDIER_ADD_PATROL_POINT = 18; // Tarea de ańadir un punto de patrol a un soldado
  public static final int TASK_SOLDIER_REMOVE_PATROL_POINT = 19; // Tarea de eliminar un punto de patrol a un soldado

  // Groups
  public static final int TASK_SOLDIER_ADD_PATROL_POINT_GROUP = 20; // Tarea de ańadir un punto de patrol a un grupo
  public static final int TASK_SOLDIER_REMOVE_PATROL_POINT_GROUP = 21; // Tarea de eliminar un punto de patrol a un
  // grupo

  // Buildings
  public static final int TASK_BUILD = 25; // Tarea de construir (edificios)
  public static final int TASK_DESTROY_BUILDING = 26;
  public static final int TASK_TURN_OFF_NON_STOP = 27;
  public static final int TASK_TURN_ON_NON_STOP = 28;

  // Terrain
  public static final int TASK_TERRAIN_RAISE = 30;
  public static final int TASK_TERRAIN_LOWER = 31;
  public static final int TASK_TERRAIN_CHANGE = 32;
  public static final int TASK_TERRAIN_ADD_FLUID = 33;
  public static final int TASK_TERRAIN_REMOVE_FLUID = 34;

  // Items
  public static final int TASK_CREATE_AND_PLACE = 40; // Tarea de construir (items) y ponerlos en algún sitio
  public static final int TASK_REMOVE_BUILDING_TASK = 41; // Tarea de eliminar el item que se está construyendo de un
  // edificio
  public static final int TASK_CREATE_IN_A_BUILDING = 42; // Tarea de construir (items) en un edificio dado
  public static final int TASK_CREATE = 43; // Tarea de construir (items) sin especificar edificio ni place
  public static final int TASK_DESTROY_ENTITY = 44;
  public static final int TASK_CREATE_AND_PLACE_ROW = 45; // Tarea de construir (items) y ponerlos en algún sitio. Se
  // crea una fila de ellos
  public static final int TASK_LOCK = 46;
  public static final int TASK_UNLOCK_OPEN = 47;
  public static final int TASK_UNLOCK_CLOSE = 48;

  // Stockpiles
  public static final int TASK_STOCKPILE = 50; // Tarea de crear stockpile
  public static final int TASK_DELETE_STOCKPILE = 51;

  // Zones
  public static final int TASK_CREATE_ZONE = 56; // Tarea de crear zonas (hospital, comedor, carpenters, ...)
  public static final int TASK_DELETE_ZONE = 57; // Tarea de eliminar zona
  public static final int TASK_EXPAND_ZONE = 58; // Tarea de expandir zona
  public static final int TASK_CHANGE_OWNER = 59; // Tarea de cambiar el propietario de la zona
  public static final int TASK_CHANGE_OWNER_GROUP = 60; // Tarea de cambiar el grupo propietario de la zona

  // Haul / Move / put in containers
  public static final int TASK_HAUL = 65; // Tarea de haul (son especiales, se crean "on the fly" y no se guardan en
  // la lista de
  // tareas, desaparecen cuando el aldeano las suelta
  public static final int TASK_MOVE_AND_LOCK = 66; // Como el haul pero persistente (SI se guarda en la lista de
  // tareas). Se usan solamente
  // en las tareas de create, en el caso de que ya haya un item en
  // el mundo y no haya que
  // construir nada
  public static final int TASK_DROP = 67; // Igual que la tarea de haul a excepción que el aldeano no tiene ir a
  // recoger nada ("on
  // the fly" también)
  public static final int TASK_PUT_IN_CONTAINER = 68; // Igual que la tarea de haul a excepción que el aldeano no
  // tiene ir a recoger nada ("on
  // the fly" también)
  public static final int TASK_REMOVE_FROM_CONTAINER = 69; // Igual que la tarea de haul a excepción que el aldeano no
  // tiene ir a recoger nada ("on
  // the fly" también)

  // Sleep / eat
  public static final int TASK_SLEEP = 70;
  public static final int TASK_EAT = 71;

  // Custom action
  public static final int TASK_CUSTOM_ACTION = 80;
  public static final int TASK_QUEUE = 81;
  public static final int TASK_QUEUE_AND_PLACE = 82;
  public static final int TASK_QUEUE_AND_PLACE_ROW = 83;
  public static final int TASK_QUEUE_AND_PLACE_AREA = 84;
  ...
  // Caravan
  public static final int TASK_MOVE_TO_CARAVAN = 100;

  // Food
  public static final int TASK_FOOD_NEEDED = 110;

  // Estados de tarea
  public static final int STATE_CREATING_INIZONE = 1; // Para marcar el inicio de un area
  public static final int STATE_CREATING_ENDZONE = 2; // Para marcar el final de un area
  public static final int STATE_CREATING_SINGLEPOINT = 3; // Para marcar un punto en el mapa
  public static final int STATE_CREATED = 10; // Para indicar que la tarea ya está creada
  ...
  // ...)
  private Point3D pointIni; // Punto inicial de la zona (también se usa en el casi de tareas de un solo punto
  // (ej: construir))
  ...
  private boolean finished = false; // Indica si la tarea está finalizada para que el gestor de taeras la elimine
  // cuando le
  // pete
  ...
  public static ArrayList<Point3DShort> getAccesingPoints(int x, int y, int z, int task) {
    ...
    // Justo arriba (la pongo al final para que sea la última opción de los aldeanos en caso de
    // mine)
  ...
  /**
   * Devuelve una lista de puntos adyacentes accesibles que estén en la zona pasada
   *
   * @param p3d
   * @para aszi
   * @para task
   * @return una lista de puntos adyacentes accesibles que estén en la zona pasada
   */
  public static ArrayList<Point3DShort> getAccesingPointsMatchingASZI(
      Point3DShort p3d,
      int aszi,
  ...
  /**
   * Indica si la tarea se considera trabajo (se usa en el modificador de happiness)
   *
   * @param oTask
   * @return
   */
  ...
  /**
   * Setea el máximo de aldeanos para la tarea. Excepciones: Si es tarea de construcción sólo permite 1 aldeano
   *
   * @param maxCitizens
   *            Máximo de aldeanos
   */
  ...
  public void setParameter(String parameter) {
    ...
    if (task == Task.TASK_QUEUE_AND_PLACE
        || task == Task.TASK_QUEUE_AND_PLACE_ROW
        || task == Task.TASK_QUEUE_AND_PLACE_AREA) {
      // Tarea queue and place, metemos en el parameter el item a crear (para el dibujado mientras
      // lo coloca) y la queueID en el parameter2
      ActionManagerItem ami = ActionManager.getItem(getParameter());
      if (ami == null) {
        Log.log(
            Log.LEVEL_ERROR,
            Messages.getString("Task.34") + getParameter() + "]",
      ...
      for (int i = alQueue.size() - 1; i >= 0; i--) {
        if (alQueue.get(i).getType() == QueueItem.TYPE_CREATE_ITEM
            || alQueue.get(i).getType() == QueueItem.TYPE_CREATE_ITEM_BY_TYPE) {
      ...
      if (sItem != null) {
        ...
        Log.log(
            Log.LEVEL_ERROR,
            Messages.getString("Task.36") + getParameter() + "]",
            getClass().toString()); // $NON-NLS-1$ //$NON-NLS-2$
        Game.deleteCurrentTask();
        return;
      }
  ...
  public void setTask(int taskID) {
    ...
    if (task == Task.TASK_MINE
        || task == Task.TASK_MINE_LADDER
        || task == Task.TASK_DIG
        || task == Task.TASK_CANCEL_ORDER
        || task == Task.TASK_STOCKPILE
        || task == Task.TASK_CREATE_ZONE
        || task == Task.TASK_EXPAND_ZONE
        || task == Task.TASK_CREATE_AND_PLACE_ROW
        || task == Task.TASK_QUEUE_AND_PLACE_ROW
        || task == Task.TASK_QUEUE_AND_PLACE_AREA
        || task == Task.TASK_CUSTOM_ACTION) {
      setState(STATE_CREATING_INIZONE);
    } else if (task == Task.TASK_BUILD
        || task == Task.TASK_CREATE_AND_PLACE
        || task == Task.TASK_QUEUE_AND_PLACE) {
  ...
  /** Crea los hotpoints, también setea el maxCitizens para la tarea segun estos */
  public void setZoneHotPoints() {
    ...
    Cell cell;
    if (getTask() == TASK_MINE
        || getTask() == TASK_DIG
        || getTask() == TASK_MINE_LADDER
        || getTask() == TASK_CUSTOM_ACTION
        || getTask() == TASK_CANCEL_ORDER) {
      ArrayList<ActionManagerItem> alAmis = new ArrayList<ActionManagerItem>(); // Con arrays por si se usa lo de
      // 2 (o más) acciones en 1 mismo
      // botón
      ArrayList<String> alParameters = new ArrayList<String>(); // Con arrays por si se usa lo de 2 (o más)
      // acciones en 1 mismo botón
      ...
      for (short x = x0; x <= x1; x++) {
        for (short y = y0; y <= y1; y++) {
          ...
          if (getTask() == Task.TASK_MINE
              || getTask() == Task.TASK_MINE_LADDER
              || getTask() == Task.TASK_DIG) {
            // MINE: Por cada celda minable ańadimos su coordenada a los hotpoints, y alloweds
            // adyacentes a las places
            ...
            if (!cell.getTerrain().hasFluids() && (!cell.isMined()) || !cell.isDiscovered()) {
              ...
              if (!existTaskPoint(getTask(), p3d)) {
                ...
                ArrayList<Point3DShort> places = getAccesingPoints(
                    x,
                    y,
            ...
            for (int a = 0; a < alAmis.size(); a++) {
              ...
              if (entity != null
                  ...
                  && ItemManager.getItem(entity.getIniHeader()).getActions().contains(sParameter)) {
                ...
                if (alLivings != null) {
                  for (int i = 0; i < alLivings.size(); i++) {
                    ...
                    if (LivingEntityManager.getItem(le.getIniHeader())
                        .getActions()
                        .contains(sParameter)) {
                      Action action = new Action(ami.getId());
                ...
                if (!bLiving) {
                  ...
                  if (cell.isMined() && cell.getCoordinates().z < (World.MAP_DEPTH - 1)) {
                    ...
                    TerrainManagerItem tmi = TerrainManager
                        .getItemByID(cellUnder.getTerrain().getTerrainID());
                    if (tmi.getActions().contains(sParameter)) {
                      // Celda posible para acción de terrain
                      boolean bCasillaOcupada = cell.getTerrain().hasFluids()
                          || cell.isFlagOrders();
                      if (!bCasillaOcupada) {
                        if (cell.hasItem()) {
      ...
      if (getTask() == Task.TASK_CANCEL_ORDER) {
        ...
        // En ese caso miramos si alguno de sus puntos se corresponde con alguno de la lista de
        // puntos a cancelar
      ...
      // Excepto las que no forman parte del edificio ya que ahora no tienen porque ser
      // rectangulares
      ...
      if (building == null) {
        Log.log(
            Log.LEVEL_ERROR,
            Messages.getString("Task.17") + getParameter() + "]",
            getClass().getName()); // $NON-NLS-1$ //$NON-NLS-2$
      } else {
        boolean bAvailableForBuilding = true;
        break1 : for (short x = x0; x < (x0 + item.getWidth()); x++) {
        ...
        if (bAvailableForBuilding) {
          ...
          break2 : for (short x = x0; x < (x0 + item.getWidth()); x++) {
            for (short y = y0; y < (y0 + item.getHeight()); y++) {
              char groundDataChar = item.getGroundData().charAt((y - y0) * item.getWidth() + (x - x0));
          ...
          if (p3d == null) {
            ...
            Log.log(
                Log.LEVEL_ERROR,
                Messages.getString("Task.31") + building.getIniHeader() + "]",
                getClass().toString()); // $NON-NLS-1$ //$NON-NLS-2$
          }
          addHotPoint(new HotPoint(p3d, p3d));
          ...
          // Tarea de construcción, metemos el building donde toca y los aldeanos ya lo construirán
          // y pondrán operativo
          ...
          // Si es un edificio automático le metemos en cola el primer item/living que pueda
          // construir y le ponemos non-stop
          if (bmi.isAutomatic()) {
            ...
            if (bSpawn) {
              // SPAWNER
              ArrayList<LivingEntityManagerItem> alItems = LivingEntityManager
                  .getItemsByBuilding(bmi.getIniHeader());
              if (alItems.size() > 0) {
              ...
              if (bmi.isMineTerrain()) {
                // Pillamos un terreno al azar de los que tiene debajo, que tenga drop y pillamos su
                // drop como primer item
                ...
                if (z < (World.MAP_DEPTH - 1)) {
                  ...
                  for (int x = x0; x < (x0 + item.getWidth()); x++) {
                    for (int y = y0; y < (y0 + item.getHeight()); y++) {
                      tmi = TerrainManager.getItemByID(
                          World.getCell(x, y, z + 1).getTerrain().getTerrainID());
                      if (tmi.getDrop() != null) {
          ...
          for (short x = x0; x < (x0 + item.getWidth()); x++) {
            for (short y = y0; y < (y0 + item.getHeight()); y++) {
              ...
              World.getCells()[x][y][z].setBuildingCoordinates(
                  Point3DShort.getPoolInstance(x0, y0, z));
      ...
      if (bStockpileOK) {
        if (stockpile.getPoints() != null && stockpile.getPoints().size() > 0) {
          ...
          // Ańadimos la stockpile al mundo
          Game.getWorld().addStockPile(stockpile);

          // Tutorial flow
          Game.updateTutorialFlow(
              TutorialTrigger.TYPE_INT_PILE,
              UtilsIniHeaders.getIntIniHeader(getParameter()),
              null);
        }
      }

      // No hay que hacer nada más, el Manager de tareas ya se encargará de crear/asignar tareas de
      // haul
            ...
            if (zmi.getType() == ZoneManagerItem.TYPE_PERSONAL) {
              ...
              for (int i = 0; i < World.getHeroIDs().size(); i++) {
                ...
                if (!hero.getCitizenData().hasZone()) {
                  ...
                  HeroPrerequisite hPrerequisite = HeroPrerequisite.getHeroPrerequisite(
                      HeroManager.getStayPrerequisites(
                          LivingEntityManager.getItem(hero.getIniHeader())
                              .getHeroStayPrerequisite()),
      ...
      if (zone != null) {
        ...
        Log.log(
            Log.LEVEL_ERROR,
            Messages.getString("Task.37"),
            getClass().toString()); // $NON-NLS-1$
      }

      // No hay que hacer nada más
    } else if (getTask() == TASK_CREATE_AND_PLACE || getTask() == TASK_QUEUE_AND_PLACE) {
      // CREATE: Miramos si en la casilla indicada se puede meter el item y, si no existe item, que
      // tengamos un edificio
      cell = cells[x0][y0][z];
      ...
      if (imi == null) {
        Log.log(
            Log.LEVEL_ERROR,
            Messages.getString("Task.30") + getParameter() + "]",
            getClass().toString()); // $NON-NLS-1$ //$NON-NLS-2$
      } else {
        // Miramos si se puede poner el item en todas las casillas (sólo 1, he borrado el
        // width/height)
        boolean bAvailableForBuilding = true;
        ...
        if (bAvailableForBuilding) {
          if (imi.canBeBuiltOnHoles()) {
            ...
            foriteming : for (short itemX = (short) (x0 - 1); itemX <= (x0 + 1); itemX++) {
        ...
        if (bAvailableForBuilding) {
          ...
          int numItems = Item.getNumItems(
              UtilsIniHeaders.getIntIniHeader(imi.getIniHeader()),
              false,
          ...
          if (numItems > 0) {
            ...
            if (aItems != null) {
              ...
              for (int i = 0; i < aItems.size(); i++) {
                ...
                if (itemAux != null
                    && itemAux.getNumericIniHeader() == imi.getNumericalIniHeader()) {
                  // Item del tipo deseado, miramos si no está locked y en la misma zona A* que el
                  // destino
                  if (!itemAux.isLocked()) {
                    ...
                    if (!itemInUse(itemAux)) {
                      ...
                      if (iItemASZID != -1
                          && (iItemASZID == iItemASZIDDestination
                              || iItemASZIDDestination == -1)) {
                        // Caso especial, ladders, estos van en una casilla digada, entonces el
                        // A*ZI
                        // será distinto
                        // Hay que mirar si las casillas adyacentes (desde donde se colocará)
                        // son
                        // accesibles
                        if (ItemManager.getItem(itemAux.getIniHeader()).canBeBuiltOnHoles()) {
                          ArrayList<Point3DShort> alPoints = getAccesingPointsMatchingASZI(
                              x0,
                              y0,
                              z,
                              iItemASZID,
                              getTask());
                          if (alPoints.size() > 0) {
                            // De guais, tenemos casillas accesibles en la misma zona que el
                            // item
                            ...
                            // Seteamos el flag de casilla con "Órdenes" en cada celda (se
                            // usa en el
                            // pintado)
                          ...
                          // Item encontrado !!! Creamos una tarea de MOVE (como las haul pero
                          // persistentes)
                          bItemEnElMundo = true;
                          Task task = new Task(TASK_MOVE_AND_LOCK);
                          task.setPointIni(itemAux.getCoordinates().toPoint3D());
                          ...
                          // Seteamos el flag de casilla con "Órdenes" en cada celda (se usa
                          // en el
                          // pintado)
                          World.getCell(x0, y0, z).setFlagOrders(true);
                          ...
                          task.setParameter(itemAux.getIniHeader());
                          task.setFace(MainPanel.itemBuildFace);
                          HotPoint hp = new HotPoint(itemAux.getCoordinates(),
                              itemAux.getCoordinates());
                          task.addHotPoint(hp);
                          Game.getWorld().getTaskManager().addTask(task);
                          break;
                        }
        ...
        if (!bItemEnElMundo) {
          if (bAvailableForBuilding) {
            ...
            if (getTask() == TASK_QUEUE_AND_PLACE) {
              ...
              // Miramos si tenemos el edificio, el más cercano (y con la cola de items más pequeńa)
              // a donde se deja el item
              ...
              // Buscamos la cola de items más pequeńa
              int iMinCola = 1000;
              ...
              for (int i = 0; i < buildings.size(); i++) {
                ...
                if (building.isOperative() && building.getIniHeader().equals(imi.getBuilding())) {
                  ...
                  // Caso especial, puentes y ladders (o items que se construyen desde una casilla
                  // anterior a destino)
                  ...
                  if (ItemManager.getItem(imi.getIniHeader()).canBeBuiltOnHoles()) {
                    ...
                    if (World.getCell(p3dBuildingAux).getAstarZoneID() == World.getCell(x0, y0, z)
                        .getAstarZoneID()) {
              ...
              if (iBuildingCercano != -1) {
                // Tenemos el edificio más cercano, lo pillamos y le ańadimos el item en su cola
                ...
                if (imi.getBuilding() != null) {
                  MessagesPanel.addMessage(
                      ...
                      Messages.getString("Task.21")
                          + imi.getName()
                          + Messages.getString("Task.22")
                          + BuildingManager.getItem(imi.getBuilding()).getName()
                          + "]",
                      ColorGL.ORANGE); // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                } else {
                  MessagesPanel.addMessage(
                      MessagesPanel.TYPE_ANNOUNCEMENT,
                      Messages.getString("Task.19") + imi.getName()
                          + Messages.getString("Task.32"),
                      ColorGL.ORANGE); // $NON-NLS-1$ //$NON-NLS-2$
                }
              }
            }
          }
    ...
    for (int t = 0; t < getHotPoints().size(); t++) {
      ...
      for (int x = (alActions.size() - 1); x >= 0; x--) {
        ...
        if (action.getDestinationPoint() != null
            && action.getDestinationPoint().equals(p3dCancel)) {
          bRemover = true;
        } else {
      ...
      if (checkCitizens) {
        ...
        for (int x = 0; x < alCitizens.size(); x++) {
          ...
          if (action != null && citizen.getCurrentTask() != null) {
            ...
            if ((action.getDestinationPoint() != null
                && action.getDestinationPoint().equals(p3dCancel))
                || (action.getTerrainPoint() != null
                    && action.getTerrainPoint().equals(p3dCancel))) {
  ...
  /**
   * Indica si, para un punto de una tarea ya existe otra tarea con el mismo punto y el mismo NO está finished Se usa
   * para DIG/CHOP/MINE/CUSTOM solamente
   *
   * @param taskID
   * @param p3d
   * @return true si para un punto de una tarea ya existe otra tarea con el mismo punto
   */
  ...
  private boolean itemInUse(Item item) {
    ...
    for (int i = 0; i < World.getCitizenIDs().size(); i++) {
      ...
      if (task != null) {
        ...
        if (task.getTask() == Task.TASK_HAUL
            || task.getTask() == Task.TASK_MOVE_AND_LOCK
            || task.getTask() == Task.TASK_PUT_IN_CONTAINER) {
    ...
    // Si llega aquí es que ningún aldeano tiene tarea con ese item, vamos a mirar que no esté
    // pendiente en el taskManager
    ArrayList<TaskManagerItem> alTasks = Game.getWorld().getTaskManager().getTaskItems();
    for (int i = 0; i < alTasks.size(); i++) {
