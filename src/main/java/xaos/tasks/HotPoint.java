...
/**
 * Clase usada por las tareas (Task's) para indicar donde hay que ir y sobre que casilla actuar. Ej: Hay que ir a la
 * posición 10,10,0 y minar la casilla 10,11,0
 */
