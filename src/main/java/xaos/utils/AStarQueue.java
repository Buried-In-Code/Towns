...
public final class AStarQueue implements Runnable {
  ...
  /**
   * Ańade una petición de búsqueda de camino A*
   *
   * @param item
   *            petición
   */
      ...
      while (iIndex >= 0) {
        ...
        if (asqi != null) {
          ...
          if (le != null) {
            ...
            // Si el path es null es que no ha encontrado camino, en ese caso levantamos el flag de
            // "recheckASZID" en World para que haga un rechequeo
