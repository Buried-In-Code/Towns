...
public final class MiniMapPanel {
  ...
  /**
   * Indica si el mouse está encima del minimapa. Como se dibuja en forma de diamante hacemos el cálculo necesario
   *
   * @param x
   * @param y
   * @return
  ...
  public static void render() {
    ...
    // Calculamos el tamańo del cuadrado amarillo teniendo en cuenta el tamańo del mainpanel y del
    // minimapa
    ...
    // Lo pasamos al tamańo que toca
    iSquareX = (iSquareX * renderWidth) / World.MAP_WIDTH;
    iSquareY = (iSquareY * renderHeight) / World.MAP_HEIGHT;

    // Lo posicionamos en la pantalla (restamos también la mitad del cuadradito amarillo para que
    // quede centrado)
    ...
    UtilsGL.drawTexture(
        iSquareX,
        iSquareY,
        iSquareX + iSquareWidth,
        iSquareY + 1,
        YELLOW_TILE.getTileSetTexX0(),
        YELLOW_TILE.getTileSetTexY0(),
        YELLOW_TILE.getTileSetTexX1(),
        YELLOW_TILE.getTileSetTexY1());
    UtilsGL.drawTexture(
        iSquareX,
        iSquareY + iSquareHeight,
        iSquareX + iSquareWidth,
        iSquareY + iSquareHeight + 1,
        YELLOW_TILE.getTileSetTexX0(),
        YELLOW_TILE.getTileSetTexY0(),
        YELLOW_TILE.getTileSetTexX1(),
        YELLOW_TILE.getTileSetTexY1());
  ...
  /**
   * Retorna el color a pintar de una celda según el terreno y/o lo que haya en ella
   *
   * @param x
   * @param y
   * @param z
    ...
    if (cell.isDiscovered()) {
      if (cell.getTerrain().hasFluids()) {
        ...
        if (cell.isMined()) {
          ...
          return TerrainManager.getTileByTileID(cell.getTerrain().getTerrainTileID())
              .getColorMiniMap();
        }
      }
    } else {
  ...
  /** Carga las texturas de cada nivel y va poniendo los IDs en el array de ID de texturas */
