...
public final class UIPanel {
  ...
  public static final int MOUSE_BOTTOM_PANEL = 1;
  public static final int MOUSE_BOTTOM_LEFT_SCROLL = 2;
  public static final int MOUSE_BOTTOM_RIGHT_SCROLL = 3;
  public static final int MOUSE_BOTTOM_ITEMS = 4;
  public static final int MOUSE_BOTTOM_SUBPANEL = 5;
  public static final int MOUSE_BOTTOM_SUBITEMS = 6;
  public static final int MOUSE_BOTTOM_OPENCLOSE = 7;
  public static final int MOUSE_MINIMAP = 10;
  public static final int MOUSE_MESSAGES_PANEL = 20;
  public static final int MOUSE_MESSAGES_ICON_COMBAT = 21;
  public static final int MOUSE_MESSAGES_ICON_SYSTEM = 22;
  public static final int MOUSE_MESSAGES_ICON_ANNOUNCEMENT = 23;
  public static final int MOUSE_MESSAGES_ICON_HEROES = 24;
  public static final int MOUSE_MESSAGES_PANEL_BUTTONS_CLOSE = 25;
  public static final int MOUSE_MESSAGES_PANEL_BUTTONS_ANNOUNCEMENT = 26;
  public static final int MOUSE_MESSAGES_PANEL_BUTTONS_COMBAT = 27;
  public static final int MOUSE_MESSAGES_PANEL_BUTTONS_HEROES = 28;
  public static final int MOUSE_MESSAGES_PANEL_BUTTONS_SYSTEM = 29;
  public static final int MOUSE_MESSAGES_PANEL_BUTTONS_SCROLL_UP = 30;
  public static final int MOUSE_MESSAGES_PANEL_BUTTONS_SCROLL_DOWN = 31;
  public static final int MOUSE_MENU_PANEL = 35;
  public static final int MOUSE_MENU_PANEL_ITEMS = 36;
  public static final int MOUSE_MENU_OPENCLOSE = 37;
  public static final int MOUSE_ICON_LEVEL_UP = 40;
  public static final int MOUSE_ICON_LEVEL_DOWN = 41;
  public static final int MOUSE_ICON_CITIZEN_NEXT = 42;
  public static final int MOUSE_ICON_CITIZEN_PREVIOUS = 43;
  public static final int MOUSE_ICON_SOLDIER_NEXT = 44;
  public static final int MOUSE_ICON_SOLDIER_PREVIOUS = 45;
  public static final int MOUSE_ICON_LEVEL = 46;
  public static final int MOUSE_ICON_HERO_NEXT = 47;
  public static final int MOUSE_ICON_HERO_PREVIOUS = 48;
  // public final static int MOUSE_INFO_CURRENT_LEVEL = 50;
  public static final int MOUSE_INFO_NUM_CITIZENS = 51;
  public static final int MOUSE_INFO_NUM_SOLDIERS = 52;
  public static final int MOUSE_INFO_NUM_HEROES = 53;
  public static final int MOUSE_INFO_CARAVAN = 54;
  public static final int MOUSE_INFOPANEL = 60;
  public static final int MOUSE_DATEPANEL = 61;
  public static final int MOUSE_PRODUCTION_PANEL = 65;
  public static final int MOUSE_PRODUCTION_PANEL_ITEMS = 66;
  // public final static int MOUSE_PRODUCTION_PANEL_ICON = 67;
  public static final int MOUSE_PRODUCTION_PANEL_ITEMS_PLUS_REGULAR = 68;
  public static final int MOUSE_PRODUCTION_PANEL_ITEMS_MINUS_REGULAR = 69;
  public static final int MOUSE_PRODUCTION_PANEL_ITEMS_PLUS_AUTOMATED = 70;
  public static final int MOUSE_PRODUCTION_PANEL_ITEMS_MINUS_AUTOMATED = 71;
  public static final int MOUSE_PRODUCTION_OPENCLOSE = 72;
  public static final int MOUSE_ICON_PRIORITIES = 77;
  public static final int MOUSE_ICON_PAUSE_RESUME = 78;
  public static final int MOUSE_ICON_SETTINGS = 79;
  public static final int MOUSE_ICON_GRID = 80;
  public static final int MOUSE_PRIORITIES_PANEL = 81;
  public static final int MOUSE_PRIORITIES_PANEL_ITEMS = 82;
  public static final int MOUSE_PRIORITIES_PANEL_ITEMS_UP = 83;
  public static final int MOUSE_PRIORITIES_PANEL_ITEMS_DOWN = 84;
  public static final int MOUSE_ICON_INCREASE_SPEED = 85;
  public static final int MOUSE_ICON_LOWER_SPEED = 86;
  public static final int MOUSE_ICON_MINIBLOCKS = 87;
  public static final int MOUSE_ICON_FLATMOUSE = 88;
  public static final int MOUSE_ICON_3DMOUSE = 89;
  public static final int MOUSE_TRADE_PANEL = 90;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_CARAVAN = 91;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_DOWN_CARAVAN = 92;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_UP_CARAVAN = 93;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_TO_BUY_CARAVAN = 94;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_TO_BUY_DOWN_CARAVAN = 95;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_TO_BUY_UP_CARAVAN = 96;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_CONFIRM = 97;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_TOWN = 98;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_DOWN_TOWN = 99;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_UP_TOWN = 100;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_TO_SELL_TOWN = 101;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_TO_SELL_DOWN_TOWN = 102;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_TO_SELL_UP_TOWN = 103;
  public static final int MOUSE_TRADE_PANEL_BUTTONS_CLOSE = 104;
  public static final int MOUSE_TRADE_PANEL_ICON_BUY = 105;
  public static final int MOUSE_TRADE_PANEL_ICON_SELL = 106;

  public static final int MOUSE_EVENTS_ICON = 107;
  // public final static int MOUSE_GODS_ICON = 108;
  public static final int MOUSE_TUTORIAL_ICON = 109;

  public static final int MOUSE_ICON_MATS = 120;
  public static final int MOUSE_MATS_PANEL = 121;
  public static final int MOUSE_MATS_PANEL_BUTTONS_CLOSE = 122;
  public static final int MOUSE_MATS_PANEL_BUTTONS_GROUPS = 123;
  public static final int MOUSE_MATS_PANEL_BUTTONS_ITEMS = 124;
  public static final int MOUSE_MATS_PANEL_BUTTONS_SCROLL_UP = 125;
  public static final int MOUSE_MATS_PANEL_BUTTONS_SCROLL_DOWN = 126;

  public static final int MOUSE_LIVINGS_PANEL = 140;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_CLOSE = 141;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS = 142;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_SCROLL_UP = 143;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_SCROLL_DOWN = 144;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_HEAD = 145;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_BODY = 146;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_LEGS = 147;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_FEET = 148;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_WEAPON = 149;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_AUTOEQUIP = 150;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER = 151;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_CIVILIAN = 152;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER_GUARD = 153;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER_PATROL = 154;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER_BOSS = 155;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_SGROUP_ADD = 156;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_SGROUP_REMOVE = 157;
  public static final int MOUSE_LIVINGS_PANEL_SGROUP_NOGROUP = 158;
  public static final int MOUSE_LIVINGS_PANEL_SGROUP_GROUP = 159;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_SGROUP_RENAME = 160;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_SGROUP_GUARD = 161;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_SGROUP_PATROL = 162;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_SGROUP_BOSS = 163;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_SGROUP_AUTOEQUIP = 164;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_SGROUP_DISBAND = 165;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_PROFESSIONS = 166;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_JOBS_GROUPS_ADDREMOVE = 167;
  public static final int MOUSE_LIVINGS_PANEL_CGROUP_NOGROUP = 168;
  public static final int MOUSE_LIVINGS_PANEL_CGROUP_GROUP = 169;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_CGROUP_RENAME = 170;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_CGROUP_AUTOEQUIP = 171;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_CGROUP_DISBAND = 172;
  public static final int MOUSE_LIVINGS_PANEL_SINGLE_CGROUP_CHANGE_JOBS = 173;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_RESTRICT_UP = 174;
  public static final int MOUSE_LIVINGS_PANEL_BUTTONS_RESTRICT_DOWN = 175;

  public static final int MOUSE_TYPING_PANEL = 180;
  public static final int MOUSE_TYPING_PANEL_CLOSE = 181;
  public static final int MOUSE_TYPING_PANEL_CONFIRM = 182;

  public static final int MOUSE_PILE_PANEL = 185;
  public static final int MOUSE_PILE_PANEL_BUTTONS_CLOSE = 186;
  public static final int MOUSE_PILE_PANEL_BUTTONS_ITEMS = 187;
  public static final int MOUSE_PILE_PANEL_BUTTONS_SCROLL_UP = 188;
  public static final int MOUSE_PILE_PANEL_BUTTONS_SCROLL_DOWN = 189;
  public static final int MOUSE_PILE_PANEL_BUTTONS_CONFIG_COPY = 190;
  public static final int MOUSE_PILE_PANEL_BUTTONS_CONFIG_LOCK = 191;
  public static final int MOUSE_PILE_PANEL_BUTTONS_CONFIG_LOCK_ALL = 192;
  public static final int MOUSE_PILE_PANEL_BUTTONS_CONFIG_UNLOCK_ALL = 193;

  public static final int MOUSE_PROFESSIONS_PANEL = 195;
  public static final int MOUSE_PROFESSIONS_PANEL_BUTTONS_CLOSE = 196;
  public static final int MOUSE_PROFESSIONS_PANEL_BUTTONS_ITEMS = 197;
  public static final int MOUSE_PROFESSIONS_PANEL_BUTTONS_SCROLL_UP = 198;
  public static final int MOUSE_PROFESSIONS_PANEL_BUTTONS_SCROLL_DOWN = 199;

  public static final int MOUSE_IMAGES_PANEL = 200;
  public static final int MOUSE_IMAGES_PANEL_CLOSE = 201;
  public static final int MOUSE_IMAGES_PANEL_PREVIOUS = 202;
  public static final int MOUSE_IMAGES_PANEL_NEXT = 203;
  public static final int MOUSE_IMAGES_PANEL_NEXT_MISSION = 204;
   ...
   * BOTTOM PANEL
   */
  private static final int BOTTOM_PANEL_SCROLL_WIDTH = 32;
  private static final int BOTTOM_PANEL_WIDTH = 1024 - (BOTTOM_PANEL_SCROLL_WIDTH * 2);
  private static final int BOTTOM_PANEL_HEIGHT = 64;
  private static final int BOTTOM_PANEL_NUM_ITEMS = 10;
  private static final int BOTTOM_ITEM_WIDTH = 64;
  private static final int BOTTOM_ITEM_HEIGHT = 64;
   ...
   * PRODUCTION PANEL
   */
  private static final int PRODUCTION_PANEL_ITEM_WIDTH = 64;
  private static final int PRODUCTION_PANEL_ITEM_HEIGHT = 64;
  ...
  public static final int TRADE_PANEL_BUTTON_WIDTH = 64;
  public static final int TRADE_PANEL_BUTTON_HEIGHT = 64;

  /*
   * PRIORITIES PANEL
   */
  private static final int PRIORITIES_PANEL_ITEM_SIZE = 64;
   ...
   * MENU PANEL
   */
  private static final int MENU_ITEM_WIDTH = 64;
  ...
  // las
  // coordenadas de los items que caben
  ...
  public static void createLivingsPanel(
      int iPanelTypeActive,
      int iSoldiersGroupActive,
      int iCitizensGroupActive) {
    ...
    LIVINGS_PANEL_WIDTH = 2 * tileLivingsPanel[3].getTileWidth()
        + 7 * tileBottomItem.getTileWidth()
        + tileScrollUp.getTileWidth();
    if (iPanelTypeActive == LIVINGS_PANEL_TYPE_CITIZENS) {
      LIVINGS_PANEL_WIDTH += (2 * tileBottomItem.getTileWidth()
          + tileLivingsRowAutoequip.getTileWidth()
          + tileLivingsRowConvertSoldier.getTileWidth()
          + tileLivingsRowProfession.getTileWidth()
          + tileLivingsRowJobsGroups.getTileWidth()
          + LIVINGS_PANEL_GROUPS_WIDTH);
    } else if (iPanelTypeActive == LIVINGS_PANEL_TYPE_SOLDIERS) {
      LIVINGS_PANEL_WIDTH += (2 * tileBottomItem.getTileWidth()
          + tileLivingsRowAutoequip.getTileWidth()
          + tileLivingsRowConvertCivilian.getTileWidth()
          + tileLivingsRowConvertSoldierGuard.getTileWidth()
          + tileLivingsRowGroupAdd.getTileWidth())
          + LIVINGS_PANEL_GROUPS_WIDTH;
    }

    LIVINGS_PANEL_HEIGHT = renderHeight
    ...
    livingsPanelPoint.setLocation(
        renderWidth / 2 - LIVINGS_PANEL_WIDTH / 2,
        iconNumCitizensBackgroundPoint.y
            + tileBottomItem.getTileHeight()
            + tileBottomItem.getTileHeight() / 4);
    livingsPanelClosePoint.setLocation(
        livingsPanelPoint.x + LIVINGS_PANEL_WIDTH - tileButtonClose.getTileWidth(),
        livingsPanelPoint.y);

    if (iPanelTypeActive == LIVINGS_PANEL_TYPE_SOLDIERS
        || iPanelTypeActive == LIVINGS_PANEL_TYPE_CITIZENS) {
      // Sub-groups panel
      livingsGroupPanelPoint.setLocation(
          livingsPanelPoint.x
              + LIVINGS_PANEL_WIDTH
              - tileLivingsPanel[3].getTileWidth()
              - LIVINGS_PANEL_GROUPS_WIDTH,
          livingsPanelPoint.y
              + (((livingsPanelPoint.y + LIVINGS_PANEL_HEIGHT) - livingsPanelPoint.y) / 2)
              - LIVINGS_PANEL_GROUPS_HEIGHT / 2);

      // Primer icono del subpanel y la separación
      int iSeparation = (LIVINGS_PANEL_GROUPS_HEIGHT
          - 2 * tileLivingsGroupPanel[3].getTileHeight()
          - tileLivingsNoGroup.getTileHeight()
          - (SoldierGroups.MAX_GROUPS * tileLivingsGroup.getTileHeight()))
          / (SoldierGroups.MAX_GROUPS + 2);
      livingsGroupPanelFirstIconPoint.setLocation(
          livingsGroupPanelPoint.x
              + LIVINGS_PANEL_GROUPS_WIDTH / 2
              - tileLivingsNoGroup.getTileWidth() / 2,
    ...
    if (checkGroupsPanelEnabled(iPanelTypeActive)) {
      iMaxHeight = LIVINGS_PANEL_HEIGHT
          - 2 * tileLivingsPanel[1].getTileHeight()
          - tileBottomItem.getTileHeight()
          - tileBottomItem.getTileHeight() / 2;
    } else {
    ...
    if (livingsPanelRowPoints == null || livingsPanelRowPoints.length < LIVINGS_PANEL_MAX_ROWS) {
      ...
      if (livingsPanelRowConvertSoldierGuardPoints == null
          || iPanelTypeActive == LIVINGS_PANEL_TYPE_SOLDIERS) {
        for (int i = 0; i < LIVINGS_PANEL_MAX_ROWS; i++) {
    ...
    for (int i = 0; i < LIVINGS_PANEL_MAX_ROWS; i++) {
      // Living
      livingsPanelRowPoints[i] = new Point(
          livingsPanelPoint.x + tileLivingsPanel[3].getTileWidth(),
          iIniY + (i * (tileBottomItem.getTileHeight() + iSeparation)) + iRowsOffsetY);

      // Equipment
      livingsPanelRowHeadPoints[i] = new Point(
          livingsPanelRowPoints[i].x
              + tileBottomItem.getTileWidth()
              + tileBottomItem.getTileWidth() / 2,
          livingsPanelRowPoints[i].y);
      livingsPanelRowBodyPoints[i] = new Point(
          livingsPanelRowHeadPoints[i].x + tileBottomItem.getTileWidth(),
          livingsPanelRowPoints[i].y);
      livingsPanelRowLegsPoints[i] = new Point(
          livingsPanelRowBodyPoints[i].x + tileBottomItem.getTileWidth(),
          livingsPanelRowPoints[i].y);
      livingsPanelRowFeetPoints[i] = new Point(
          livingsPanelRowLegsPoints[i].x + tileBottomItem.getTileWidth(),
          livingsPanelRowPoints[i].y);
      livingsPanelRowWeaponPoints[i] = new Point(
          livingsPanelRowFeetPoints[i].x + tileBottomItem.getTileWidth(),
          livingsPanelRowPoints[i].y);

      // Autoequip
      livingsPanelRowAutoequipPoints[i] = new Point(
          livingsPanelRowWeaponPoints[i].x
              + tileBottomItem.getTileWidth()
              + tileBottomItem.getTileWidth() / 2,
          livingsPanelRowWeaponPoints[i].y
              + tileBottomItem.getTileHeight() / 2
      ...
      livingsPanelRowConvertCivilianSoldierPoints[i] = new Point(
          livingsPanelRowAutoequipPoints[i].x
              + tileLivingsRowAutoequip.getTileWidth()
              + tileBottomItem.getTileWidth() / 2,
          livingsPanelRowWeaponPoints[i].y
              + tileBottomItem.getTileHeight() / 2
      ...
      livingsPanelRowJobsGroupsPoints[i] = new Point(
          ...
          livingsPanelRowProfessionPoints[i].y
              + tileLivingsRowProfession.getTileHeight() / 2
      ...
      if (livingsPanelSoldiersGroupActive == -1) {
        for (int i = 0; i < LIVINGS_PANEL_MAX_ROWS; i++) {
          ...
          livingsPanelRowGroupPoints[i] = new Point(
              livingsPanelRowConvertSoldierPatrolPoints[i].x,
        ...
        if (iPanelTypeActive == LIVINGS_PANEL_TYPE_SOLDIERS
          ...
          LIVINGS_PANEL_SINGLE_GROUP_WIDTH = livingsPanelRowGroupPoints[0].x
              + tileLivingsRowGroupRemove.getTileWidth()
              - livingsPanelRowPoints[0].x;
          LIVINGS_PANEL_SINGLE_GROUP_HEIGHT = tileBottomItem.getTileHeight()
              + tileBottomItem.getTileHeight() / 2;
          livingsSingleGroupPanelPoint.setLocation(
              livingsPanelRowPoints[0].x,
              iIniY - tileLivingsGroupPanel[1].getTileHeight() / 2);

          int iSeparationSingleGroup = (LIVINGS_PANEL_SINGLE_GROUP_WIDTH
              - 2 * tileLivingsGroupPanel[3].getTileWidth()
              - tileLivingsSingleGroupRename.getTileWidth()
              - tileLivingsSingleGroupGuard.getTileWidth()
              - tileLivingsSingleGroupPatrol.getTileWidth()
              - tileLivingsSingleGroupBoss.getTileWidth()
              - tileLivingsRowAutoequip.getTileWidth()
              - tileLivingsSingleGroupDisband.getTileWidth())
              / 5;
          // Botones del single group panel
          int iFirstButton = livingsSingleGroupPanelPoint.x + tileLivingsGroupPanel[3].getTileWidth();
          // Rename
          livingsSingleGroupRenamePoint.setLocation(
              iFirstButton,
              livingsSingleGroupPanelPoint.y
                  + LIVINGS_PANEL_SINGLE_GROUP_HEIGHT / 2
                  - tileLivingsSingleGroupRename.getTileHeight() / 2);
          iFirstButton += tileLivingsSingleGroupRename.getTileWidth() + iSeparationSingleGroup;
          // Guard
          livingsSingleGroupGuardPoint.setLocation(
              iFirstButton,
              livingsSingleGroupPanelPoint.y
                  + LIVINGS_PANEL_SINGLE_GROUP_HEIGHT / 2
                  - tileLivingsSingleGroupGuard.getTileHeight() / 2);
          iFirstButton += tileLivingsSingleGroupGuard.getTileWidth() + iSeparationSingleGroup;
          // Patrol
          livingsSingleGroupPatrolPoint.setLocation(
              iFirstButton,
              livingsSingleGroupPanelPoint.y
                  + LIVINGS_PANEL_SINGLE_GROUP_HEIGHT / 2
                  - tileLivingsSingleGroupPatrol.getTileHeight() / 2);
          iFirstButton += tileLivingsSingleGroupPatrol.getTileWidth() + iSeparationSingleGroup;
          // Boss
          livingsSingleGroupBossPoint.setLocation(
              iFirstButton,
              livingsSingleGroupPanelPoint.y
                  + LIVINGS_PANEL_SINGLE_GROUP_HEIGHT / 2
                  - tileLivingsSingleGroupBoss.getTileHeight() / 2);
          iFirstButton += tileLivingsSingleGroupBoss.getTileWidth() + iSeparationSingleGroup;
          // Autoequip
          livingsSingleGroupAutoequipPoint.setLocation(
              iFirstButton,
              livingsSingleGroupPanelPoint.y
                  + LIVINGS_PANEL_SINGLE_GROUP_HEIGHT / 2
                  - tileLivingsRowAutoequip.getTileHeight() / 2);
          ...
          // Disband
          livingsSingleGroupDisbandPoint.setLocation(
              iFirstButton,
              livingsSingleGroupPanelPoint.y
                  + LIVINGS_PANEL_SINGLE_GROUP_HEIGHT / 2
      ...
      if (livingsPanelCitizensGroupActive == -1) {
        ...
        if (iPanelTypeActive == LIVINGS_PANEL_TYPE_CITIZENS
          ...
          int iSeparationSingleGroup = (LIVINGS_PANEL_SINGLE_GROUP_WIDTH
              ...
              - tileLivingsRowAutoequip.getTileWidth()
              - tileLivingsSingleGroupDisband.getTileWidth()
              - tileLivingsSingleGroupChangeJobs.getTileWidth())
              / 3;
          // Botones del single group panel
          int iFirstButton = livingsSingleGroupPanelPoint.x + tileLivingsGroupPanel[3].getTileWidth();
          // Rename
          ...
          iFirstButton += tileLivingsRowAutoequip.getTileWidth() + iSeparationSingleGroup;
          // Change jobs
          livingsSingleGroupChangeJobsPoint.setLocation(
              iFirstButton,
              livingsSingleGroupPanelPoint.y
                  + LIVINGS_PANEL_SINGLE_GROUP_HEIGHT / 2
    ...
    if (iPanelTypeActive == LIVINGS_PANEL_TYPE_SOLDIERS) {
      if (livingsPanelSoldiersGroupActive != -1) {
        ...
        livingsPanelIconScrollDownPoint.setLocation(
            livingsGroupPanelPoint.x
                - tileBottomItem.getTileWidth() / 2
                - tileScrollDown.getTileWidth(),
            livingsPanelRowPoints[LIVINGS_PANEL_MAX_ROWS - 1].y
                + tileBottomItem.getTileWidth()
        ...
        livingsPanelIconScrollDownPoint.setLocation(
            livingsGroupPanelPoint.x
                ...
                - tileScrollDown.getTileWidth(),
            livingsPanelPoint.y
                + LIVINGS_PANEL_HEIGHT
                - tileLivingsPanel[1].getTileHeight()
                - tileScrollDown.getTileHeight());
      }
    } else if (iPanelTypeActive == LIVINGS_PANEL_TYPE_CITIZENS) {
      if (livingsPanelCitizensGroupActive != -1) {
        ...
        livingsPanelIconRestrictDownPoint.setLocation(
            livingsPanelIconScrollUpPoint.x
                + tileScrollUp.getTileWidth()
    ...
    livingsPanelPagesPoint.setLocation(
        livingsPanelIconScrollUpPoint.x + tileScrollUp.getTileWidth() / 2,
        livingsPanelIconScrollUpPoint.y
            + tileScrollUp.getTileHeight()
            + iSeparationScroll / 2
  ...
  public static void drawTile(Tile tile, Point point) {
    UtilsGL.drawTexture(
        point.x,
        point.y,
        point.x + tile.getTileWidth(),
        point.y + tile.getTileHeight(),
  ...
  public static boolean keyPressed(int tecla) {
    if (tecla == Keyboard.KEY_ESCAPE) {
      if (imagesPanel != null && ImagesPanel.isVisible()) {
        ...
        setLivingsPanelActive(
            LIVINGS_PANEL_TYPE_NONE,
            livingsPanelSoldiersGroupActive,
  ...
  /**
   * Renderiza el background con los 8 tiles de los lados y esquinas 0: background 1: N 2: S 3: E 4: W 5: NE 6: NW 7:
   * SE 8: SW
   *
   * @param tiles
   */
  ...
  public static void setBottomMenuPanelActive(
      boolean bottomMenuPanelActive,
  ...
  public static void setPilePanelActive(int iPileContainerID, boolean isContainer) {
    ...
    if (iPileContainerID != -1) {
      ...
      if (menuPile != null) {
        // Cambiamos el tamańo de los iconos
  ...
  public static void setProfessionsPanelActive(
      int iProfessionsCitizenOrGroupID,
      boolean isCitizen) {
    ...
    if (UIPanel.tradePanelActive != tradePanelActive) {
      if (tradePanelActive) {
        ...
        Game.updateTutorialFlow(
            ...
            TutorialTrigger.ICON_INT_TRADE,
            null);
      } else {
        UIPanel.tradePanelActive = tradePanelActive; // Se pone primero pq sino el Game.resume no funcionará

        // Se desactiva el panel, quitamos la pausa si al activar el panel el juego no estaba
        // pausado
  ...
  public static void toggleTutorialPanel(boolean bNewGame) {
    if (Game.getCurrentMissionData() != null
        && Game.getCurrentMissionData().getTutorialFlows().size() > 0) {
      if (imagesPanel == null) {
        imagesPanel = new ImagesPanel(
            MainPanel.renderWidth, MainPanel.renderHeight, Game.getCurrentMissionData());
        if (bNewGame) {
  ...
  private static boolean checkGroupsPanelEnabled(int iLivingsPanelActive) {
    return (iLivingsPanelActive == LIVINGS_PANEL_TYPE_CITIZENS
        && livingsPanelCitizensGroupActive != -1)
        || (iLivingsPanelActive == LIVINGS_PANEL_TYPE_SOLDIERS
            && livingsPanelSoldiersGroupActive != -1);
  }
  ...
  private static void createPilePanel() {
    ...
    PILE_PANEL_HEIGHT = renderHeight
        - (iconMatsPoint.y + tileIconMats.getTileHeight())
        - tileBottomItem.getTileHeight()
        - tileBottomItem.getTileHeight() / 2;

    pilePanelPoint.setLocation(
        renderWidth / 8 - ((renderWidth / 8) / 2),
        iconMatsPoint.y + tileIconMats.getTileHeight() + tileBottomItem.getTileHeight() / 4);
    pilePanelClosePoint.setLocation(
        pilePanelPoint.x + PILE_PANEL_WIDTH - tileButtonClose.getTileWidth(),
        pilePanelPoint.y);
    ...
    pilePanelIconConfigCopyPoint.setLocation(
        ...
        pilePanelPoint.y
            + PILE_PANEL_HEIGHT
            - tileConfigCopy.getTileHeight()
            - UtilFont.MAX_HEIGHT / 2);
    pilePanelIconConfigLockPoint.setLocation(
        pilePanelPoint.x
            + PILE_PANEL_WIDTH / 2
            - tileConfigCopy.getTileWidth()
            - tileConfigCopy.getTileWidth() / 2,
        pilePanelPoint.y
            + PILE_PANEL_HEIGHT
            - tileConfigLock.getTileHeight()
            - UtilFont.MAX_HEIGHT / 2);
    ...
    // Pages
    pilePanelPagesPositionPoint.setLocation(
        pilePanelIconScrollUpPoint.x + tileScrollUp.getTileWidth() / 2,
        pilePanelIconScrollUpPoint.y
            + tileScrollUp.getTileHeight()
    ...
    int iMaxItemsWidth = (PILE_PANEL_WIDTH
        - tileScrollUp.getTileWidth()
        - 4 * tileMatsPanelSubPanel[3].getTileWidth())
    ...
    int iSeparationW = (PILE_PANEL_WIDTH
        - tileScrollUp.getTileWidth()
        - 4 * tileMatsPanelSubPanel[3].getTileWidth()
        - iMaxItemsWidth * tileBottomItem.getTileWidth())
        / (iMaxItemsWidth + 1);
    int iSeparationH = (PILE_PANEL_HEIGHT
        - 2 * tileMatsPanelSubPanel[1].getTileHeight()
        - iMaxItemsHeight * tileBottomItem.getTileHeight())
        / (iMaxItemsHeight + 1);
    ...
    for (int y = 0; y < iMaxItemsHeight; y++) {
      for (int x = 0; x < iMaxItemsWidth; x++) {
        pilePanelItemPoints[i] = new Point(
  ...
  private static void createProductionPanel(SmartMenu menu) {
    int iFirstY = iconNumCitizensBackgroundPoint.y
        + tileBottomItem.getTileHeight()
        + tileBottomItem.getTileHeight() / 4;
    int iLastY;
    ...
    PRODUCTION_PANEL_WIDTH = PRODUCTION_PANEL_NUM_ITEMS_X
        * (PRODUCTION_PANEL_ITEM_WIDTH + PIXELS_TO_BORDER + 2 * ICON_WIDTH)
        + PIXELS_TO_BORDER;
    ...
    productionPanelPoint.setLocation(
        tileOpenProductionPanel.getTileWidth(),
    ...
    bucle1 : for (int y = 0; y < PRODUCTION_PANEL_NUM_ITEMS_Y; y++) {
      for (int x = 0; x < PRODUCTION_PANEL_NUM_ITEMS_X; x++) {
        ...
        if (smItem.getType() == SmartMenu.TYPE_ITEM
          ...
          productionPanelItemsMinusRegularPosition.add(
              new Point(p.x - ICON_WIDTH, p.y + PRODUCTION_PANEL_ITEM_HEIGHT - ICON_HEIGHT));
          productionPanelItemsPlusAutomatedPosition.add(
              new Point(p.x + PRODUCTION_PANEL_ITEM_WIDTH, p.y));
          productionPanelItemsMinusAutomatedPosition.add(
              new Point(
                  p.x + PRODUCTION_PANEL_ITEM_WIDTH,
    ...
    tileOpenCloseProductionPanelPoint.setLocation(
        0,
  ...
  private static void createProfessionsPanel() {
    ...
    PROFESSIONS_PANEL_HEIGHT = renderHeight
        - (iconMatsPoint.y + tileIconMats.getTileHeight())
        - tileBottomItem.getTileHeight()
        - tileBottomItem.getTileHeight() / 2;

    professionsPanelPoint.setLocation(
        renderWidth / 8 - ((renderWidth / 8) / 2),
        iconMatsPoint.y + tileIconMats.getTileHeight() + tileBottomItem.getTileHeight() / 4);
    ...
    // Scroll up/down
    professionsPanelIconScrollUpPoint.setLocation(
        professionsPanelPoint.x
            + PROFESSIONS_PANEL_WIDTH
            - tileMatsPanel[3].getTileWidth()
            - tileScrollUp.getTileWidth(),
    ...
    professionsPanelPagesPositionPoint.setLocation(
        ...
        professionsPanelIconScrollUpPoint.y
            + tileScrollUp.getTileHeight()
    ...
    // Miramos de cuantas filas y columnas disponemos y seteamos el array de posiciones
    int iMaxItemsWidth = (PROFESSIONS_PANEL_WIDTH
        - tileScrollUp.getTileWidth()
        - 4 * tileMatsPanelSubPanel[3].getTileWidth())
        / (tileBottomItem.getTileWidth() + 8);
    ...
    int iSeparationW = (PROFESSIONS_PANEL_WIDTH
        - tileScrollUp.getTileWidth()
        - 4 * tileMatsPanelSubPanel[3].getTileWidth()
        - iMaxItemsWidth * tileBottomItem.getTileWidth())
        / (iMaxItemsWidth + 1);
    int iSeparationH = (PROFESSIONS_PANEL_HEIGHT
        - 2 * tileMatsPanelSubPanel[1].getTileHeight()
        - iMaxItemsHeight * tileBottomItem.getTileHeight())
        / (iMaxItemsHeight + 1);
  ...
  private static void drawTile(Tile tile, Point point, int width, int height, boolean bigger) {
    ...
    if (bigger) {
      UtilsGL.drawTexture(
          point.x - (tile.getTileWidth() / 4) + iTemp,
          point.y - (tile.getTileHeight() / 4) + iTemp2,
          point.x + tile.getTileWidth() + (tile.getTileWidth() / 4) + iTemp,
          point.y + tile.getTileHeight() + (tile.getTileHeight() / 4) + iTemp2,
          tile.getTileSetTexX0(),
          tile.getTileSetTexY0(),
          tile.getTileSetTexX1(),
          tile.getTileSetTexY1());
      ...
      UtilsGL.drawTexture(
          point.x + iTemp,
          point.y + iTemp2,
          point.x + tile.getTileWidth() + iTemp,
          point.y + tile.getTileHeight() + iTemp2,
          tile.getTileSetTexX0(),
          tile.getTileSetTexY0(),
          tile.getTileSetTexX1(),
          tile.getTileSetTexY1());
  ...
  private static void drawTile(
    ...
    if (bigger) {
      UtilsGL.drawTexture(
          pointX - (tile.getTileWidth() / 4) + iTemp,
          pointY - (tile.getTileHeight() / 4) + iTemp2,
          pointX + tile.getTileWidth() + (tile.getTileWidth() / 4) + iTemp,
          pointY + tile.getTileHeight() + (tile.getTileHeight() / 4) + iTemp2,
          tile.getTileSetTexX0(),
          tile.getTileSetTexY0(),
          tile.getTileSetTexX1(),
          tile.getTileSetTexY1());
      ...
      UtilsGL.drawTexture(
          pointX + iTemp,
          pointY + iTemp2,
          pointX + tile.getTileWidth() + iTemp,
          pointY + tile.getTileHeight() + iTemp2,
          tile.getTileSetTexX0(),
          tile.getTileSetTexY0(),
          tile.getTileSetTexX1(),
          tile.getTileSetTexY1());
  ...
  private static void resizePilePanel(SmartMenu menuPile) {
    ...
    if (iRows <= 1) {
      // Lo hacemos pequeńo por la derecha
      int iSeparationW = (PILE_PANEL_WIDTH
          - tileScrollUp.getTileWidth()
          - 4 * tileMatsPanelSubPanel[3].getTileWidth()
          - iMaxItemsWidth * tileBottomItem.getTileWidth())
  ...
  private static void resizeProfessionsPanel(SmartMenu menuProfessions) {
    ...
    if (iRows <= 1) {
      ...
      PROFESSIONS_PANEL_WIDTH = iFirstWidth
          + ((menuProfessions.getItems().size() + 1)
              * (tileBottomItem.getTileWidth() + iSeparationW));
    } else {
      PROFESSIONS_PANEL_WIDTH = (renderWidth / 8) * 7;
    }
  ...
  public void initialize(String sCampaignID, String sMissionID, boolean bLoadMenus) {
    ...
    for (int i = 0; i < BOTTOM_PANEL_NUM_ITEMS; i++) {
      bottomPanelItemsPosition.add(
          new Point(
              bottomPanelX + spaceBetweenItems + (i * (BOTTOM_ITEM_WIDTH + spaceBetweenItems)),
    ...
    infoPanelPoint.setLocation(
        renderWidth / 2 - tileInfoPanel.getTileWidth() / 2 + tileInfoPanel.getTileWidthOffset(),
        0);

    int iSeparation = datePanelPoint.x - infoPanelPoint.x;
    iSeparation -= 2 * tileBottomItem.getTileWidth();
    iSeparation /= 3;
    // Citizens
    iconNumCitizensBackgroundPoint.setLocation(
        infoPanelPoint.x + iSeparation,
    ...
    iSeparation = infoPanelPoint.x
        + tileInfoPanel.getTileWidth()
    ...
    iconTutorialPoint.setLocation(
        messageIconPoints[0].x,
        messageIconPoints[0].y
            + messageTiles[0].getTileHeight()
            + PIXELS_TO_BORDER
            + BOTTOM_ITEM_HEIGHT
    ...
    iconEventsPoint.setLocation(
        iStartingX + iAvailableWidth / 4 - ICON_WIDTH / 2 + 3,
    ...
    // Gods icon
    // iconGodsPoint.setLocation (iStartingX + (iAvailableWidth / 4) * 3 - ICON_WIDTH / 2 + 3,
    // iconEventsPoint.y + GlobalEventData.getIcon ().getTileHeight () / 2 -
    // tileIconGods.getTileHeight () / 2);
    ...
    int iPanels = (tileDatePanel.getTileWidth()
        - tileIconPriorities.getTileWidth()
        - tileIconMats.getTileWidth())
        / 3;
    iconMatsPoint.setLocation(
        datePanelPoint.x + iPanels,
   ...
   * @param x
   * @param y
   * @param doEdgeMenusStuff.
   *            Setea el delay a 0 si el mouse está en uno de los paneles laterales, también abre/cierra menus y tal
   * @return
   */
  public int isMouseOnAPanel(int x, int y, boolean doEdgeMenusStuff) {
    ...
    if (typingPanel != null) {
      if (isMouseOnTypingPanel(x, y)) {
        if (isMouseOnAnIcon(
            x,
            y,
            TypingPanel.getCloseButtonPoint(),
            tileButtonClose,
            tileButtonCloseAlpha)) {
          return MOUSE_TYPING_PANEL_CLOSE;
        } else if (isMouseOnAnIcon(
            x,
            y,
            TypingPanel.getConfirmPoint(),
            TypingPanel.getTileConfirm(),
    ...
    if (imagesPanel != null && ImagesPanel.isVisible()) {
      if (isMouseOnImagesPanel(x, y)) {
        if (isMouseOnAnIcon(
            x,
            y,
            ImagesPanel.getCloseButtonPoint(),
            tileButtonClose,
            tileButtonCloseAlpha)) {
          return MOUSE_IMAGES_PANEL_CLOSE;
            ...
            x,
            y,
            ImagesPanel.getPreviousImagePoint(),
            ImagesPanel.getTilePrevious())) {
          return MOUSE_IMAGES_PANEL_PREVIOUS;
        } else if (isMouseOnAnIcon(
            x,
            y,
            ImagesPanel.getNextImagePoint(),
            ImagesPanel.getTileNext())) {
          return MOUSE_IMAGES_PANEL_NEXT;
        } else if (isMouseOnAnIcon(
            x,
            y,
            ImagesPanel.getNextMissionPoint(),
            ImagesPanel.getTileNextMission())) {
    ...
    if (isBottomMenuPanelActive()) {
      ...
      if (isMouseOnBottomPanel(
          x,
          y)) { // Este check tiene que ir detrás de los items, ya que los items están encima
        if (doEdgeMenusStuff) {
          // Cerramos los menús no locked
          closeNonLockedMenus(false, true, true);
          delayTime = 0;
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        iconCitizenPreviousPoint,
        tileIconCitizenPrevious,
        tileIconPreviousMiniAlpha)) {
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        iconSoldierPreviousPoint,
        tileIconSoldierPrevious,
        tileIconPreviousMiniAlpha)) {
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        iconHeroPreviousPoint,
        tileIconHeroPrevious,
        tileIconPreviousMiniAlpha)) {
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        iconNumCitizensBackgroundPoint,
        tileBottomItem,
        tileBottomItemAlpha)) {
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        iconNumSoldiersBackgroundPoint,
        tileBottomItem,
        tileBottomItemAlpha)) {
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        iconIncreaseSpeedPoint,
        tileIconIncreaseSpeed,
        tileIconIncreaseSpeedAlpha)) {
  ...
  public void mousePressed(int x, int y, int mouseButton) {
     ...
     */
    if (typingPanel != null) {
      if (iPanel == MOUSE_TYPING_PANEL_CLOSE
          || (mouseButton == 1 && iPanel == MOUSE_TYPING_PANEL)) {
        typingPanel = null;
     ...
     */
    if (imagesPanel != null && ImagesPanel.isVisible()) {
      if (iPanel == MOUSE_IMAGES_PANEL_CLOSE
          || (mouseButton == 1 && iPanel == MOUSE_IMAGES_PANEL)) {
        ImagesPanel.setVisible(false);
        UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
        return;
    ...
    if (isProfessionsPanelActive()) {
      if (iPanel == MOUSE_PROFESSIONS_PANEL_BUTTONS_CLOSE) {
        ...
        UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
        return;
      } else if (professionsPanelMaxPages > 1
          && iPanel == MOUSE_PROFESSIONS_PANEL_BUTTONS_SCROLL_UP) {
        ...
        return;
          ...
          && iPanel == MOUSE_PROFESSIONS_PANEL_BUTTONS_SCROLL_DOWN) {
        ...
        if (p != null && p.y < menuProfessions.getItems().size()) {
          ...
          if (menuAux.getCommand().equals(CommandPanel.COMMAND_BACK)) {
            ...
            CommandPanel.executeCommand(
                menuAux.getCommand(),
                menuAux.getParameter(),
                menuAux.getParameter2(),
                menuAux.getDirectCoordinates(),
                null,
                SmartMenu.ICON_TYPE_ITEM);
            // Regeneramos el menu
            if (professionsPanelIsCitizen) {
              if (!ActionPriorityManager.regenerateProfessionsPanelMenu(
                  menuProfessions,
                  professionsPanelCitizenOrGroupIDActive)) {
                setProfessionsPanelActive(-1, false);
              }
            } else {
              if (!ActionPriorityManager.regenerateJobGroupPanelMenu(
                  menuProfessions,
                  professionsPanelCitizenOrGroupIDActive)) {
                setProfessionsPanelActive(-1, false);
              }
        ...
        if (p != null && p.y < menuPile.getItems().size()) {
          ...
          if (menuAux.getCommand().equals(CommandPanel.COMMAND_BACK)) {
            ...
            if (isPilePanelIsContainer()) {
              // Container
              if (!Container.regenerateContainerPanelMenu(
                  pilePanelPileContainerIDActive,
                  menuPile)) {
                setPilePanelActive(-1, false);
              }
            } else {
    ...
    if (isMessagesPanelActive()) {
      ...
      if (iPanel == MOUSE_MESSAGES_PANEL_BUTTONS_CLOSE) {
        ...
        if (MessagesPanel.getPages(iMessagesType) > 1
            && MessagesPanel.getPagesCurrent(iMessagesType) > 1) {
        ...
        if (mouseButton == 1) { // Botón derecho (cerramos)
          ...
          if (MessagesPanel.mousePressed(
              x,
              y,
              getMessagesPanelActive(),
    ...
    if (isLivingsPanelActive()) {
      if (iPanel == MOUSE_LIVINGS_PANEL_BUTTONS_CLOSE) {
        ...
        if (iNumLivings > 0) {
          int iNumPages = (iNumLivings % LIVINGS_PANEL_MAX_ROWS == 0)
              ? iNumLivings / LIVINGS_PANEL_MAX_ROWS
        ...
        Game.updateTutorialFlow(
            TutorialTrigger.TYPE_INT_ICONHIT,
            TutorialTrigger.ICON_INT_LIVINGS_RESTRICTION,
            null);
        return;
          ...
          if (p != null) {
            ...
            if (alLivings != null
              ...
              if (le != null) {
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_LIVINGS_GROUPS,
                    null);
                return;
              }
            }
                ...
                for (int g = 0; g < CitizenGroups.MAX_GROUPS; g++) {
                  ...
                  if (citizen.getCitizenData().getGroupID() != g) {
                    sm.addItem(
                        new SmartMenu(
                            SmartMenu.TYPE_ITEM,
                            Messages.getString("UIPanel.70") + cgd.getName(),
                            null,
                    ...
                    sm.addItem(
                        new SmartMenu(
                            SmartMenu.TYPE_ITEM,
                            Messages.getString("UIPanel.71") + cgd.getName(),
                            null,
                            CommandPanel.COMMAND_CITIZEN_SET_JOB_GROUP,
                            Integer.toString(citizen.getID()),
                            Integer.toString(-1),
        ...
        if (livingsPanelSoldiersGroupActive != -1) {
          typingPanel = new TypingPanel(
              renderWidth,
              renderHeight,
              Messages.getString("UIPanel.61"),
              Game.getWorld()
                  .getSoldierGroups()
                  .getGroup(livingsPanelSoldiersGroupActive)
                  .getName(),
              TypingPanel.TYPE_RENAME_GROUP,
              livingsPanelSoldiersGroupActive); // $NON-NLS-1$
          UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
          return;
        }
        ...
        if (livingsPanelCitizensGroupActive != -1) {
          typingPanel = new TypingPanel(
              ...
              Game.getWorld()
                  .getCitizenGroups()
                  .getGroup(livingsPanelCitizensGroupActive)
                  .getName(),
              TypingPanel.TYPE_RENAME_JOB_GROUP,
              livingsPanelCitizensGroupActive); // $NON-NLS-1$
          UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
          return;
        }
        ...
        if (livingsPanelSoldiersGroupActive != -1) {
          ArrayList<Integer> alSoldiers = Game.getWorld()
              .getSoldierGroups()
              .getGroup(livingsPanelSoldiersGroupActive)
              .getLivingIDs();
          LivingEntity le;
          for (int s = 0; s < alSoldiers.size(); s++) {
            ...
            if (le != null) {
              CommandPanel.executeCommand(
                  CommandPanel.COMMAND_AUTOEQUIP,
                  Integer.toString(le.getID()),
                  null,
                  null,
                  null,
                  SmartMenu.ICON_TYPE_ITEM);
        ...
        UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
        return;
      } else if (iPanel == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS
          || iPanel == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_HEAD
          ...
          if (alLivings != null
            ...
            if (le != null) {
              if (iPanel == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS) {
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_LIVINGS_LIVINGS,
                    null);
                return;
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_LIVINGS_JOBS,
                    null);
                return;
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_LIVINGS_CONVERTSOLDIER,
                    null);
                return;
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_LIVINGS_CONVERTCIVILIAN,
                    null);
                return;
                ...
                CommandPanel.executeCommand(
                    CommandPanel.COMMAND_SOLDIER_SET_STATE,
                    Integer.toString(le.getID()),
                    Integer.toString(SoldierData.STATE_GUARD),
                    new Point3D(-1, -1, -1),
                    null,
                    SmartMenu.ICON_TYPE_ITEM);
                UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
                ...
                CommandPanel.executeCommand(
                    CommandPanel.COMMAND_SOLDIER_SET_STATE,
                    Integer.toString(le.getID()),
                    Integer.toString(SoldierData.STATE_PATROL),
                    new Point3D(-1, -1, -1),
                    null,
                    SmartMenu.ICON_TYPE_ITEM);
                UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
                ...
                CommandPanel.executeCommand(
                    CommandPanel.COMMAND_SOLDIER_SET_STATE,
                    Integer.toString(le.getID()),
                    Integer.toString(SoldierData.STATE_BOSS_AROUND),
                    new Point3D(-1, -1, -1),
                    null,
                    SmartMenu.ICON_TYPE_ITEM);
                UtilsAL.play(UtilsAL.SOURCE_FX_CLICK);
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (mi != null) {
                    smUnequip = new SmartMenu(
                        SmartMenu.TYPE_ITEM,
                        Messages.getString("Citizen.20")
                            + le.getEquippedData().getHead().getExtendedTilename(),
                        null,
                        CommandPanel.COMMAND_WEAR_OFF,
                        null,
                        null,
                        new Point3D(le.getID(), MilitaryItem.LOCATION_HEAD, -1),
                        le.getEquippedData().getHead().getItemTextColor()); // $NON-NLS-1$
                  }
                  ...
                  Game.updateTutorialFlow(
                      TutorialTrigger.TYPE_INT_ICONHIT,
                      TutorialTrigger.ICON_INT_LIVINGS_BODY,
                      null);
                  return;
                }
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (mi != null) {
                    smUnequip = new SmartMenu(
                        ...
                        le.getEquippedData().getBody().getItemTextColor()); // $NON-NLS-1$
                  }
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (mi != null) {
                    smUnequip = new SmartMenu(
                        ...
                        le.getEquippedData().getLegs().getItemTextColor()); // $NON-NLS-1$
                  }
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (mi != null) {
                    smUnequip = new SmartMenu(
                        ...
                        le.getEquippedData().getFeet().getItemTextColor()); // $NON-NLS-1$
                  }
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (mi != null) {
                    smUnequip = new SmartMenu(
                        ...
                        le.getEquippedData().getWeapon().getItemTextColor()); // $NON-NLS-1$
                  }
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  Game.updateTutorialFlow(
                      TutorialTrigger.TYPE_INT_ICONHIT,
                      TutorialTrigger.ICON_INT_LIVINGS_AUTOEQUIP,
                      null);
                  return;
                }
              }
            ...
            if (smItem.getType() == SmartMenu.TYPE_MENU) {
              ...
              if (!smItem.getCommand().equalsIgnoreCase(CommandPanel.COMMAND_BACK)) {
                CommandPanel.executeCommand(
                    smItem.getCommand(),
                    smItem.getParameter(),
                    smItem.getParameter2(),
                    smItem.getDirectCoordinates(),
                    smItem.getIcon(),
                    smItem.getIconType());
          ...
          if (p.x == MOUSE_PRODUCTION_PANEL_ITEMS_PLUS_REGULAR) {
            ...
            if (smItem.getType() == SmartMenu.TYPE_ITEM) {
              if (!smItem.getCommand().equalsIgnoreCase(CommandPanel.COMMAND_BACK)) {
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_REGULAR_PLUS,
                    null,
                    smItem.getParameter());
          ...
          if (p.x == MOUSE_PRODUCTION_PANEL_ITEMS_MINUS_REGULAR) {
            ...
            if (smItem.getType() == SmartMenu.TYPE_ITEM) {
              if (!smItem.getCommand().equalsIgnoreCase(CommandPanel.COMMAND_BACK)) {
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_REGULAR_MINUS,
                    null,
                    smItem.getParameter());
          ...
          if (p.x == MOUSE_PRODUCTION_PANEL_ITEMS_PLUS_AUTOMATED) {
            ...
            if (smItem.getType() == SmartMenu.TYPE_ITEM) {
              if (!smItem.getCommand().equalsIgnoreCase(CommandPanel.COMMAND_BACK)) {
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_AUTOMATED_PLUS,
                    null,
                    smItem.getParameter());
          ...
          if (p.x == MOUSE_PRODUCTION_PANEL_ITEMS_MINUS_AUTOMATED) {
            ...
            if (smItem.getType() == SmartMenu.TYPE_ITEM) {
              if (!smItem.getCommand().equalsIgnoreCase(CommandPanel.COMMAND_BACK)) {
                ...
                Game.updateTutorialFlow(
                    TutorialTrigger.TYPE_INT_ICONHIT,
                    TutorialTrigger.ICON_INT_AUTOMATED_MINUS,
                    null,
                    smItem.getParameter());
    ...
    if (iPanel == MOUSE_INFO_NUM_CITIZENS) {
      if (getLivingsPanelActive() != LIVINGS_PANEL_TYPE_CITIZENS) {
        setLivingsPanelActive(
            LIVINGS_PANEL_TYPE_CITIZENS,
            livingsPanelSoldiersGroupActive,
            livingsPanelCitizensGroupActive);

        Game.updateTutorialFlow(
            TutorialTrigger.TYPE_INT_ICONHIT,
            TutorialTrigger.ICON_INT_CITIZENS,
            null);
      } else {
        setLivingsPanelActive(
            LIVINGS_PANEL_TYPE_NONE,
    ...
    if (iPanel == MOUSE_INFO_NUM_SOLDIERS) {
      if (getLivingsPanelActive() != LIVINGS_PANEL_TYPE_SOLDIERS) {
        setLivingsPanelActive(
            LIVINGS_PANEL_TYPE_SOLDIERS,
            livingsPanelSoldiersGroupActive,
            livingsPanelCitizensGroupActive);

        Game.updateTutorialFlow(
            TutorialTrigger.TYPE_INT_ICONHIT,
            TutorialTrigger.ICON_INT_SOLDIERS,
            null);
      } else {
        setLivingsPanelActive(
            LIVINGS_PANEL_TYPE_NONE,
    ...
    if (iPanel == MOUSE_INFO_NUM_HEROES) {
      if (getLivingsPanelActive() != LIVINGS_PANEL_TYPE_HEROES) {
        setLivingsPanelActive(
            LIVINGS_PANEL_TYPE_HEROES,
            livingsPanelSoldiersGroupActive,
            livingsPanelCitizensGroupActive);

        Game.updateTutorialFlow(
            TutorialTrigger.TYPE_INT_ICONHIT,
            TutorialTrigger.ICON_INT_HEROES,
            null);
      } else {
        setLivingsPanelActive(
            LIVINGS_PANEL_TYPE_NONE,
  ...
  public void render() {
     ...
     * BOTTOM menu panel
     */
    int iCurrentTexture = tileBottomScrollLeft
        .getTextureID(); // Esta textura es la primera quese usa en el bottom menu
    ...
    if (isBottomMenuPanelLocked()) {
      ...
      drawTile(
          tileOpenBottomMenuON,
          tileOpenCloseBottomMenuPoint,
          tileOpenBottomMenuON.getTileWidth(),
          tileOpenBottomMenuON.getTileHeight(),
          mousePanel == MOUSE_BOTTOM_OPENCLOSE);
    } else {
    ...
    UtilsGL.drawTexture(
        minimapPanelX,
        minimapPanelY,
        minimapPanelX + MINIMAP_PANEL_WIDTH,
        minimapPanelY + MINIMAP_PANEL_HEIGHT,
        tileMinimapPanel.getTileSetTexX0(),
        tileMinimapPanel.getTileSetTexY0(),
        tileMinimapPanel.getTileSetTexX1(),
    ...
    drawTile(
        ...
        ICON_WIDTH,
        ICON_HEIGHT,
        mousePanel == MOUSE_ICON_LEVEL_UP);
    if (tutorialFlow != null && tutorialFlow.isBlinkMiniLevelUp()) {
      UtilsGL.unsetColor();
    }
    ...
    drawTile(
        ...
        ICON_WIDTH,
        ICON_HEIGHT,
        mousePanel == MOUSE_ICON_LEVEL_DOWN);
    if (tutorialFlow != null && tutorialFlow.isBlinkMiniLevelDown()) {
      UtilsGL.unsetColor();
    }
    ...
    drawTile(
        isMatsPanelActive() ? tileIconMatsON : tileIconMats,
        iconMatsPoint,
        (mousePanel == MOUSE_ICON_MATS));
    iCurrentTexture = UtilsGL.setTexture(
        isPrioritiesPanelActive() ? tileIconPrioritiesON : tileIconPriorities,
        iCurrentTexture);
    drawTile(
        isPrioritiesPanelActive() ? tileIconPrioritiesON : tileIconPriorities,
        iconPrioritiesPoint,
    ...
    drawTile(
        tileIconCoins,
        tileIconCoinsPoint.x - iTownsCoinsWidth / 2 - tileIconCoins.getTileWidth() / 2,
        tileIconCoinsPoint.y,
        false);

    // Icons (miniblock + grid + settings + flat mouse + 3d mouse)
    iCurrentTexture = UtilsGL.setTexture(
        MainPanel.bMiniBlocksON ? tileIconMiniblocksON : tileIconMiniblocks,
        iCurrentTexture);
    ...
    drawTile(
        MainPanel.gridON ? tileIconGridON : tileIconGrid,
        iconGridPoint,
        (mousePanel == MOUSE_ICON_GRID));
    if (tutorialFlow != null && tutorialFlow.isBlinkMiniGrid()) {
      UtilsGL.unsetColor();
    }
    ...
    drawTile(
        MainPanel.flatMouseON ? tileIconFlatMouseON : tileIconFlatMouse,
        iconFlatMousePoint,
    ...
    drawTile(
        MainPanel.tDMouseON ? tileIcon3DMouseON : tileIcon3DMouse,
        icon3DMousePoint,
    ...
    // Message icons
    if (getMessagesPanelActive() == MessagesPanel.TYPE_ANNOUNCEMENT
        || (MessagesPanel.getBlink()[MessagesPanel.TYPE_ANNOUNCEMENT]
            && blinkTurns >= MAX_BLINK_TURNS / 2)) {
      iCurrentTexture = UtilsGL.setTexture(messageTilesON[0], iCurrentTexture);
      drawTile(
          messageTilesON[0],
          messageIconPoints[0],
          (mousePanel == MOUSE_MESSAGES_ICON_ANNOUNCEMENT));
    } else {
    ...
    if (getMessagesPanelActive() == MessagesPanel.TYPE_COMBAT
        || (MessagesPanel.getBlink()[MessagesPanel.TYPE_COMBAT]
            && blinkTurns >= MAX_BLINK_TURNS / 2)) {
    ...
    if (getMessagesPanelActive() == MessagesPanel.TYPE_HEROES
        || (MessagesPanel.getBlink()[MessagesPanel.TYPE_HEROES]
            && blinkTurns >= MAX_BLINK_TURNS / 2)) {
    ...
    if (getMessagesPanelActive() == MessagesPanel.TYPE_SYSTEM
        || (MessagesPanel.getBlink()[MessagesPanel.TYPE_SYSTEM]
            && blinkTurns >= MAX_BLINK_TURNS / 2)) {
    ...
    if (World.SPEED < World.SPEED_MAX) {
      ...
      drawTile(
          tileIconIncreaseSpeedON,
          iconIncreaseSpeedPoint,
          (mousePanel == MOUSE_ICON_INCREASE_SPEED));
    } else {
    ...
    UtilsGL.drawString(
        sLevel,
        iconLevelPoint.x + tileIconLevel.getTileWidth() / 2 - sLevelW / 2,
        iconLevelPoint.y + tileIconLevel.getTileHeight() / 2 - UtilFont.MAX_HEIGHT / 2,
        ColorGL.BLACK);
    UtilsGL.drawString(
        sNumCitizens,
        iconNumCitizensPoint.x + tileIconNumCitizens.getTileWidth() / 2 - numCitizensW / 2,
        iconNumCitizensPoint.y + tileIconNumCitizens.getTileHeight(),
        ColorGL.BLACK);
    UtilsGL.drawString(
        sNumSoldiers,
        iconNumSoldiersPoint.x + tileIconNumSoldiers.getTileWidth() / 2 - numSoldiersW / 2,
        iconNumSoldiersPoint.y + tileIconNumSoldiers.getTileHeight(),
        ColorGL.BLACK);
    UtilsGL.drawString(
        sNumHeroes,
        iconNumHeroesPoint.x + tileIconNumHeroes.getTileWidth() / 2 - numHeroesW / 2,
        iconNumHeroesPoint.y + tileIconNumHeroes.getTileHeight(),
        ColorGL.BLACK);
    UtilsGL.drawString(
        sDate,
        datePanelPoint.x + tileDatePanel.getTileWidth() / 2 - dateW / 2,
        datePanelPoint.y + tileDatePanel.getTileHeight() / 2 - UtilFont.MAX_HEIGHT / 2,
        ColorGL.BLACK);
    UtilsGL.drawString(
        sTownCoins,
        tileIconCoinsPoint.x - iTownsCoinsWidth / 2 + tileIconCoins.getTileWidth() / 2,
        tileIconCoinsPoint.y + tileIconCoins.getTileHeight() / 2 - UtilFont.MAX_HEIGHT / 2,
        ColorGL.WHITE);
    ...
    if (TownsProperties.DEBUG_MODE) {
      ...
      UtilsGL.drawStringWithBorder(
          "Shadows " + ged.isShadows(),
          2,
          3 * UtilFont.MAX_HEIGHT,
          ColorGL.WHITE,
          ColorGL.BLACK); // $NON-NLS-1$
      UtilsGL.drawStringWithBorder(
          "Half shadows " + ged.isHalfShadows(),
          2,
          4 * UtilFont.MAX_HEIGHT,
          ColorGL.WHITE,
          ColorGL.BLACK); // $NON-NLS-1$
      UtilsGL.drawStringWithBorder(
          "RGB " + ged.getRed() + "," + ged.getGreen() + "," + ged.getBlue(),
          2,
          5 * UtilFont.MAX_HEIGHT,
          ColorGL.WHITE,
          ColorGL.BLACK); // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
      UtilsGL.drawStringWithBorder(
          "waitPCT " + ged.getWaitPCT(),
          2,
          6 * UtilFont.MAX_HEIGHT,
          ColorGL.WHITE,
          ColorGL.BLACK); // $NON-NLS-1$
      UtilsGL.drawStringWithBorder(
          "walkSpeedPCT " + ged.getWalkSpeedPCT(),
          2,
          7 * UtilFont.MAX_HEIGHT,
          ColorGL.WHITE,
          ColorGL.BLACK); // $NON-NLS-1$
      ...
      // }
      //
      // UtilsGL.drawStringWithBorder (sbEvents.toString (), 2, 2 + 10 * UtilFont.MAX_HEIGHT,
  ...
  private void createBottomSubPanel(SmartMenu smItem) {
    ...
    bottomSubPanelPoint.setLocation(
        bottomPanelX,
        bottomPanelY - PIXELS_TO_BORDER - BOTTOM_SUBPANEL_HEIGHT);
    ...
    bucle1 : for (int y1 = 0; y1 < BOTTOM_SUBPANEL_NUM_ITEMS_Y; y1++) {
      for (int x1 = 0; x1 < BOTTOM_SUBPANEL_NUM_ITEMS_X; x1++) {
        if ((y1 * BOTTOM_SUBPANEL_NUM_ITEMS_X + x1) < smItem.getItems().size()) {
          bottomSubPanelItemsPosition.add(
              new Point(
                  bottomSubPanelPoint.x
                      + PIXELS_TO_BORDER
                      + (x1 * (BOTTOM_SUBITEM_WIDTH + PIXELS_TO_BORDER)),
  ...
  private void createMatsPanel() {
    ...
    MATS_PANEL_HEIGHT = renderHeight
        - (iconMatsPoint.y + tileIconMats.getTileHeight())
        - tileBottomItem.getTileHeight()
        - tileBottomItem.getTileHeight() / 2;

    matsPanelPoint.setLocation(
        renderWidth / 8 - ((renderWidth / 8) / 2),
        iconMatsPoint.y + tileIconMats.getTileHeight() + tileBottomItem.getTileHeight() / 4);
    matsPanelClosePoint.setLocation(
        matsPanelPoint.x + MATS_PANEL_WIDTH - tileButtonClose.getTileWidth(),
        matsPanelPoint.y);
    ...
    // Pages
    matsPanelPagesPositionPoint.setLocation(
        matsPanelIconScrollUpPoint.x + tileScrollUp.getTileWidth() / 2,
    ...
    MATS_PANEL_SUBPANEL_HEIGHT = (matsPanelIconScrollDownPoint.y + tileScrollDown.getTileHeight())
        - matsPanelIconScrollUpPoint.y;
    matsPanelSubPanelPoint.setLocation(
        matsPanelPoint.x + tileMatsPanelSubPanel[3].getTileWidth(),
        matsPanelIconScrollUpPoint.y);

    // Posición de iconos (los X de arriba) dentro del panel (va aquí pq tienen que centrarse con el
    // subpanel)
    ...
    for (int i = 0; i < MatsPanelData.numGroups; i++) {
      matsPanelIconPoints[i] = new Point(
          matsPanelSubPanelPoint.x
              + iSeparation
              + (i * (tileBottomItem.getTileWidth() + iSeparation)),
    ...
    int iSeparationW = (MATS_PANEL_SUBPANEL_WIDTH
        - 2 * tileMatsPanelSubPanel[3].getTileWidth()
        - iMaxItemsWidth * tileBottomItem.getTileWidth())
        / (iMaxItemsWidth + 1);
    int iSeparationH = (MATS_PANEL_SUBPANEL_HEIGHT
        - 2 * tileMatsPanelSubPanel[1].getTileHeight()
        - iMaxItemsHeight * tileBottomItem.getTileHeight())
        / (iMaxItemsHeight + 1);
    ...
    for (int i = 0; i < MATS_PANEL_MAX_ITEMS_PER_PAGE; i++) {
      ...
      if (x > (matsPanelSubPanelPoint.x
          + MATS_PANEL_SUBPANEL_WIDTH
          - tileMatsPanelSubPanel[3].getTileWidth()
          - tileBottomItem.getTileWidth()
          - 1)) {
  ...
  private void createMenuPanel(SmartMenu menu) {
    MENU_PANEL_HEIGHT = renderHeight
    ...
    menuPanelPoint.setLocation(
        renderWidth - MENU_PANEL_WIDTH - tileOpenRightMenu.getTileWidth(),
        minimapPanelY + MINIMAP_PANEL_HEIGHT + 2 * PIXELS_TO_BORDER);
    ...
    for (int y = 0; y < MENU_PANEL_NUM_ITEMS_Y; y++) {
      for (int x = 0; x < MENU_PANEL_NUM_ITEMS_X; x++) {
        menuPanelItemsPosition.add(
            new Point(
                menuPanelPoint.x + PIXELS_TO_BORDER + (x * (MENU_ITEM_WIDTH + PIXELS_TO_BORDER)),
                menuPanelPoint.y + PIXELS_TO_BORDER + (y * (MENU_ITEM_HEIGHT + PIXELS_TO_BORDER))));
      }
    }

    // Minibotón para abrir/cerrar el menú
    tileOpenCloseRightMenuPoint.setLocation(
        renderWidth - tileOpenRightMenu.getTileWidth(),
  ...
  private void createMessagesPanel() {
    ...
    // Tamańo y close button
    MESSAGES_PANEL_WIDTH = (renderWidth / 8) * 7;
    MESSAGES_PANEL_HEIGHT = renderHeight
        - (iconNumCitizensBackgroundPoint.y + tileBottomItem.getTileHeight())
        - tileBottomItem.getTileHeight() / 2;
    messagesPanelPoint.setLocation(
        renderWidth / 8 - ((renderWidth / 8) / 2),
        iconNumCitizensBackgroundPoint.y
            + tileBottomItem.getTileHeight()
            + tileBottomItem.getTileHeight() / 4);
    messagesPanelClosePoint.setLocation(
        messagesPanelPoint.x + MESSAGES_PANEL_WIDTH - tileButtonClose.getTileWidth(),
        messagesPanelPoint.y);

    // Mini iconos y puntos (los que salen arriba a la izquierda de la pantalla, no los de dentro
    // del panel)
    ...
    for (int i = 0; i < MessagesPanel.MAX_TYPES; i++) {
      messageIconPoints[i] = new Point(
          PIXELS_TO_BORDER + i * (messageTiles[i].getTileWidth() + PIXELS_TO_BORDER),
          PIXELS_TO_BORDER);
    }
    ...
    messagePanelIconScrollUpPoint.setLocation(
        messagesPanelPoint.x
            + MESSAGES_PANEL_WIDTH
            - tileMessagesPanel[3].getTileWidth()
            - tileScrollUp.getTileWidth(),
        messagesPanelPoint.y
            + tileMessagesPanel[1].getTileHeight()
            + messagePanelTiles[0].getTileHeight());
    messagePanelIconScrollDownPoint.setLocation(
        messagesPanelPoint.x
            ...
            - tileScrollUp.getTileWidth(),
        messagesPanelPoint.y
            + MESSAGES_PANEL_HEIGHT
            - tileScrollDown.getTileHeight()
            - tileMessagesPanel[1].getTileHeight());

    // Pages
    messagePanelPagesPositionPoint.setLocation(
        messagePanelIconScrollUpPoint.x + tileScrollUp.getTileWidth() / 2,
    ...
    MESSAGES_PANEL_SUBPANEL_HEIGHT = (messagePanelIconScrollDownPoint.y + tileScrollDown.getTileHeight())
        - messagePanelIconScrollUpPoint.y;
    messagesPanelSubPanelPoint.setLocation(
        messagesPanelPoint.x + tileMessagesPanel[3].getTileWidth(),
        messagePanelIconScrollUpPoint.y);

    // Posición de iconos (los 4 de arriba) dentro del panel (va aquí pq tienen que centrarse con el
    // subpanel)
    messagePanelIconPoints = new Point[MessagesPanel.MAX_TYPES];
    int iSeparation = (MESSAGES_PANEL_SUBPANEL_WIDTH
        - (MessagesPanel.MAX_TYPES * messagePanelTiles[0].getTileWidth()))
        / (MessagesPanel.MAX_TYPES + 1);
    for (int i = 0; i < MessagesPanel.MAX_TYPES; i++) {
      messagePanelIconPoints[i] = new Point(
          messagesPanelSubPanelPoint.x
              + iSeparation
  ...
  private void createMilitaryContextMenu(
      SmartMenu smToAdd,
      int iLocation,
      LivingEntity le,
      int mouseX,
      int mouseY) {
    // Equipar, miramos si hay objetos militares en el mundo, de paso ya hacemos una lista para
    // poner en el menú
      ...
      for (int i = 0; i < alMilitaryItems.size(); i++) {
        ...
        if (militaryItem.getZ() > Game.getWorld().getRestrictHaulEquippingLevel()) {
          smMilitary.addItem(
              new SmartMenu(
                  SmartMenu.TYPE_ITEM,
                  Messages.getString("UIPanel.79") + militaryItem.getExtendedTilename(),
                  null,
                  CommandPanel.COMMAND_WEAR,
                  Integer.toString(le.getID()),
                  Integer.toString(militaryItem.getID()),
                  militaryItem.getCoordinates().toPoint3D(),
                  militaryItem.getItemTextColor())); // $NON-NLS-1$
        } else {
          smMilitary.addItem(
              new SmartMenu(
                  SmartMenu.TYPE_ITEM,
                  militaryItem.getExtendedTilename(),
                  null,
                  CommandPanel.COMMAND_WEAR,
                  Integer.toString(le.getID()),
                  Integer.toString(militaryItem.getID()),
  ...
  private void createPrioritiesPanel() {
    ...
    // Tenemos el tamańo de los items
    PRIORITIES_PANEL_WIDTH = PRIORITIES_PANEL_ITEM_SIZE + 2 * tilePrioritiesPanelUpIcon.getTileWidth();
    PRIORITIES_PANEL_HEIGHT = 2 * PIXELS_TO_BORDER
        + (PRIORITIES_PANEL_NUM_ITEMS * PRIORITIES_PANEL_ITEM_SIZE)
    ...
    if (PRIORITIES_PANEL_NUM_ITEMS > 1 && PRIORITIES_PANEL_HEIGHT > iMaxHeight) {
      if (iMaxHeight - 2 * PIXELS_TO_BORDER != 0) { // Check división por 0
        iNumColumns = PRIORITIES_PANEL_HEIGHT
            / (iMaxHeight
                - 2 * PIXELS_TO_BORDER); // Realmente no entiendo el 2*PIXELS en esta operación
      ...
      PRIORITIES_PANEL_WIDTH = iNumColumns
          * (PRIORITIES_PANEL_ITEM_SIZE
              + 2 * tilePrioritiesPanelUpIcon.getTileWidth()
              + PIXELS_TO_BORDER);
      PRIORITIES_PANEL_HEIGHT = 2 * PIXELS_TO_BORDER
          + (MAX_ITEMS_PER_COLUMN * PRIORITIES_PANEL_ITEM_SIZE)
          + ((MAX_ITEMS_PER_COLUMN - 1) * iPixelsBetweenItems);
    } else {
      iNumColumns = 1;
    }

    prioritiesPanelPoint.setLocation(
        renderWidth / 2 - PRIORITIES_PANEL_WIDTH / 2,
    ...
    for (int i = 0; i < PRIORITIES_PANEL_NUM_ITEMS; i++) {
      p = new Point(
          prioritiesPanelPoint.x
              + tilePrioritiesPanelUpIcon.getTileWidth()
              + (iColumnIndex
                  * (PRIORITIES_PANEL_ITEM_SIZE + 2 * ICON_WIDTH + iPixelsBetweenItems)),
          prioritiesPanelPoint.y
              + PIXELS_TO_BORDER
              + ((i - (iColumnIndex * MAX_ITEMS_PER_COLUMN))
                  * (PRIORITIES_PANEL_ITEM_SIZE + iPixelsBetweenItems)));
      prioritiesPanelItemsPosition.add(p);
      if (i != (PRIORITIES_PANEL_NUM_ITEMS - 1)) {
        if (i > 0) {
          prioritiesPanelItemsUpPosition.add(
              new Point(p.x - ICON_WIDTH, p.y + PRIORITIES_PANEL_ITEM_SIZE / 2 - ICON_HEIGHT / 2));
        } else {
          prioritiesPanelItemsUpPosition.add(new Point(-1, -1));
        }
        if (i < (PRIORITIES_PANEL_NUM_ITEMS - 2)) {
          prioritiesPanelItemsDownPosition.add(
              new Point(
                  p.x + PRIORITIES_PANEL_ITEM_SIZE,
  ...
  private void createTradePanel() {
    ...
    TRADE_PANEL_HEIGHT = renderHeight
        - (iconNumCitizensBackgroundPoint.y + tileBottomItem.getTileHeight())
        - tileBottomItem.getTileHeight() / 2;
    tradePanelPoint.setLocation(
        renderWidth / 8 - ((renderWidth / 8) / 2),
        iconNumCitizensBackgroundPoint.y
            + tileBottomItem.getTileHeight()
            + tileBottomItem.getTileHeight() / 4);
    tradePanelClosePoint.setLocation(
        tradePanelPoint.x + TRADE_PANEL_WIDTH - tileButtonClose.getTileWidth(),
        tradePanelPoint.y);

    TradePanel.loadStatics();
    if (tradePanel != null
        && Game.getWorld() != null
        && Game.getWorld().getCurrentCaravanData() != null) {
  ...
  private boolean isMouseOnBottomLeftScroll(int x, int y) {
    if ((y >= bottomPanelY && y < (bottomPanelY + BOTTOM_PANEL_HEIGHT))
        && (x >= bottomPanelLeftScrollX
            && x < (bottomPanelLeftScrollX + BOTTOM_PANEL_SCROLL_WIDTH))) {
  ...
  private boolean isMouseOnBottomRightScroll(int x, int y) {
    if ((y >= bottomPanelY && y < (bottomPanelY + BOTTOM_PANEL_HEIGHT))
        && (x >= bottomPanelRightScrollX
            && x < (bottomPanelRightScrollX + BOTTOM_PANEL_SCROLL_WIDTH))) {
  ...
  private int isMouseOnBottomSubItems(int x, int y) {
    if (bottomSubPanelMenu != null
        && y >= bottomSubPanelPoint.y
        && y < (bottomSubPanelPoint.y + BOTTOM_SUBPANEL_HEIGHT)
        && x >= bottomSubPanelPoint.x
      ...
      bucle1 : for (int y1 = 0; y1 < BOTTOM_SUBPANEL_NUM_ITEMS_Y; y1++) {
        for (int x1 = 0; x1 < BOTTOM_SUBPANEL_NUM_ITEMS_X; x1++) {
          ...
          if (x >= point.x
              && x < (point.x + BOTTOM_SUBITEM_WIDTH)
              && y >= point.y
  ...
  private boolean isMouseOnImagesPanel(int x, int y) {
    return ((y >= ImagesPanel.getPanelPoint().y
        && y < (ImagesPanel.getPanelPoint().y + ImagesPanel.HEIGHT))
        && (x >= ImagesPanel.getPanelPoint().x
            && x < (ImagesPanel.getPanelPoint().x + ImagesPanel.WIDTH)));
  }
  ...
  private Point isMouseOnLivingsButtons(int x, int y) {
    ...
    if (x >= point.x
        && x < (point.x + tileButtonClose.getTileWidth())
        && y >= point.y
    ...
    if (x >= point.x
        && x < (point.x + tileScrollUp.getTileWidth())
        && y >= point.y
    ...
    if (x >= point.x
        && x < (point.x + tileScrollDown.getTileWidth())
        && y >= point.y
    ...
    if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_SOLDIERS) {
      ...
      if (x >= point.x
          && x < (point.x + tileLivingsNoGroup.getTileWidth())
          && y >= point.y
      ...
      for (int i = 0; i < SoldierGroups.MAX_GROUPS; i++) {
        point = new Point(
            livingsGroupPanelFirstIconPoint.x,
            livingsGroupPanelFirstIconPoint.y + (i + 1) * livingsGroupPanelIconsSeparation);
        if (x >= point.x
            && x < (point.x + tileLivingsGroup.getTileWidth())
            && y >= point.y
      ...
      point = livingsGroupPanelFirstIconPoint;
      if (x >= point.x
          && x < (point.x + tileLivingsNoJobGroup.getTileWidth())
          && y >= point.y
      ...
      for (int i = 0; i < SoldierGroups.MAX_GROUPS; i++) {
        point = new Point(
            ...
            livingsGroupPanelFirstIconPoint.y + (i + 1) * livingsGroupPanelIconsSeparation);
        if (x >= point.x
            && x < (point.x + tileLivingsJobGroup.getTileWidth())
            && y >= point.y
    ...
    if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS) {
      ...
      if (livingsPanelCitizensGroupActive != -1) {
        ...
        if (x >= point.x
            && x < (point.x + tileLivingsSingleJobGroupRename.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileLivingsRowAutoequip.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileLivingsSingleGroupChangeJobs.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileLivingsSingleJobGroupDisband.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileIconLevelUp.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileIconLevelDown.getTileWidth())
            && y >= point.y
      ...
      if (livingsPanelSoldiersGroupActive != -1) {
        point = livingsSingleGroupRenamePoint;
        if (x >= point.x
            && x < (point.x + tileLivingsSingleGroupRename.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileLivingsSingleGroupGuard.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileLivingsSingleGroupPatrol.getTileWidth())
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + tileLivingsSingleGroupBoss.getTileWidth())
            && y >= point.y
        ...
        point = livingsSingleGroupDisbandPoint;
        if (x >= point.x
            && x < (point.x + tileLivingsSingleGroupDisband.getTileWidth())
            && y >= point.y
    ...
    if (iNumLivings > 0) {
      ...
      int iMaxRows = Math.min(
          iNumLivings - ((iIndexPage - 1) * LIVINGS_PANEL_MAX_ROWS),
      ...
      for (int i = 0; i < iMaxRows; i++) {
        ...
        if (x >= point.x
            && x < (point.x + tileBottomItem.getTileWidth())
            && y >= point.y
        ...
        if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS) {
          ...
          if (x >= point.x
              && x < (point.x + tileLivingsRowConvertSoldier.getTileWidth())
              && y >= point.y
          ...
          if (livingsPanelCitizensGroupActive == -1) {
            ...
            if (x >= point.x
                && x < (point.x + tileLivingsRowProfession.getTileWidth())
                && y >= point.y
          ...
          if (x >= point.x
              && x < (point.x + tileLivingsRowJobsGroups.getTileWidth())
              && y >= point.y
          ...
          point = livingsPanelRowConvertCivilianSoldierPoints[i];
          if (x >= point.x
              && x < (point.x + tileLivingsRowConvertCivilian.getTileWidth())
              && y >= point.y
          ...
          if (livingsPanelSoldiersGroupActive == -1) {
            ...
            if (x >= point.x
                && x < (point.x + tileLivingsRowConvertSoldierGuard.getTileWidth())
                && y >= point.y
                && y < (point.y + tileLivingsRowConvertSoldierGuard.getTileHeight())) {
            ...
            if (x >= point.x
                && x < (point.x + tileLivingsRowConvertSoldierPatrol.getTileWidth())
                && y >= point.y
                && y < (point.y + tileLivingsRowConvertSoldierPatrol.getTileHeight())) {
            ...
            if (x >= point.x
                && x < (point.x + tileLivingsRowConvertSoldierBoss.getTileWidth())
                && y >= point.y
                && y < (point.y + tileLivingsRowConvertSoldierBoss.getTileHeight())) {
            ...
            if (x >= point.x
                && x < (point.x + tileLivingsRowGroupAdd.getTileWidth())
                && y >= point.y
            ...
            point = livingsPanelRowGroupPoints[i];
            if (x >= point.x
                && x < (point.x + tileLivingsRowGroupRemove.getTileWidth())
                && y >= point.y
  ...
  private Point isMouseOnMatsButtons(int x, int y) {
    ...
    if (getMatsPanelActive() != -1) {
      ...
      int iMin = Math.min(
          MatsPanelData.tileGroups.get(getMatsPanelActive()).size() - iFirstIndex,
  ...
  private Point isMouseOnMessagesButtons(int x, int y) {
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        messagePanelIconPoints[MessagesPanel.TYPE_COMBAT],
        messagePanelTiles[MessagesPanel.TYPE_COMBAT],
        messagePanelTilesAlpha.get(MessagesPanel.TYPE_COMBAT))) {
      return MOUSE_MESSAGES_PANEL_BUTTONS_COMBAT_POINT;
    }
    if (isMouseOnAnIcon(
        x,
        y,
        messagePanelIconPoints[MessagesPanel.TYPE_HEROES],
        messagePanelTiles[MessagesPanel.TYPE_HEROES],
        messagePanelTilesAlpha.get(MessagesPanel.TYPE_HEROES))) {
      return MOUSE_MESSAGES_PANEL_BUTTONS_HEROES_POINT;
    }
    if (isMouseOnAnIcon(
        x,
        y,
        messagePanelIconPoints[MessagesPanel.TYPE_SYSTEM],
        messagePanelTiles[MessagesPanel.TYPE_SYSTEM],
        messagePanelTilesAlpha.get(MessagesPanel.TYPE_SYSTEM))) {
    ...
    if (isMouseOnAnIcon(
        x,
        y,
        messagePanelIconScrollUpPoint,
        tileScrollUp,
        tileScrollUpButtonAlpha)) {
      return MOUSE_MESSAGES_PANEL_BUTTONS_SCROLL_UP_POINT;
    }
    if (isMouseOnAnIcon(
        x,
        y,
        messagePanelIconScrollDownPoint,
        tileScrollDown,
        tileScrollDownButtonAlpha)) {
  ...
  private boolean isMouseOnMinimap(int x, int y) {
    if (y >= minimapPanelY
        && y < (minimapPanelY + MINIMAP_PANEL_HEIGHT)
        && x >= minimapPanelX
  ...
  private Point isMouseOnPileButtons(int x, int y) {
    ...
    if (x >= point.x
        && x < (point.x + tileConfigCopy.getTileWidth())
        && y >= point.y
    ...
    if (x >= point.x
        && x < (point.x + tileConfigLock.getTileWidth())
        && y >= point.y
    ...
    if (x >= point.x
        && x < (point.x + tileConfigLockAll.getTileWidth())
        && y >= point.y
    ...
    if (x >= point.x
        && x < (point.x + tileConfigUnlockAll.getTileWidth())
        && y >= point.y
  ...
  private Point isMouseOnPrioritiesItems(int x, int y) {
    ...
    if (y >= prioritiesPanelPoint.y
        && y < (prioritiesPanelPoint.y + PRIORITIES_PANEL_HEIGHT)
        && x >= prioritiesPanelPoint.x
        && x < (prioritiesPanelPoint.x + PRIORITIES_PANEL_WIDTH)) {
      Point point;
      for (int i = 0; i < PRIORITIES_PANEL_NUM_ITEMS; i++) {
        point = prioritiesPanelItemsPosition.get(i);
        if (x >= point.x
            && x < (point.x + PRIORITIES_PANEL_ITEM_SIZE)
            && y >= point.y
        ...
        if (x >= point.x
            && x < (point.x + ICON_WIDTH)
            && y >= point.y
            && y < (point.y + ICON_HEIGHT)) {
  ...
  private Point isMouseOnProductionItems(int x, int y) {
    if (y >= productionPanelPoint.y
        && y < (productionPanelPoint.y + PRODUCTION_PANEL_HEIGHT)
        && x >= productionPanelPoint.x
        && x < (productionPanelPoint.x + PRODUCTION_PANEL_WIDTH)) {
      Point point;
      bucle1 : for (int y1 = 0; y1 < PRODUCTION_PANEL_NUM_ITEMS_Y; y1++) {
        for (int x1 = 0; x1 < PRODUCTION_PANEL_NUM_ITEMS_X; x1++) {
          ...
          if (x >= point.x
              && x < (point.x + PRODUCTION_PANEL_ITEM_WIDTH)
              && y >= point.y
  ...
  private Point isMouseOnProfessionsButtons(int x, int y) {
    ...
    if (menuProfessions != null) {
      ...
      int iMin = Math.min(
          menuProfessions.getItems().size() - iFirstIndex,
  ...
  private boolean isMouseOnProfessionsPanel(int x, int y) {
    return ((y >= professionsPanelPoint.y
        && y < (professionsPanelPoint.y + PROFESSIONS_PANEL_HEIGHT))
        && (x >= professionsPanelPoint.x
            && x < (professionsPanelPoint.x + PROFESSIONS_PANEL_WIDTH)));
  }
  ...
  private Point isMouseOnTradeButtons(int x, int y) {
    ...
    if (tradePanel != null
        && y >= tradePanelPoint.y
        && y < (tradePanelPoint.y + TRADE_PANEL_HEIGHT)
        && x >= tradePanelPoint.x
        && x < (tradePanelPoint.x + TRADE_PANEL_WIDTH)) {
      // Scroll up caravan
      ...
      if (x >= point.x
          && x < (point.x + TradePanel.tileTradeConfirm.getTileWidth())
          && y >= point.y
      ...
      for (int i = 0; i < tradePanel.getAlButtonPointsCaravan().size(); i++) {
        ...
        if (x >= point.x
            && x < (point.x + TRADE_PANEL_BUTTON_WIDTH)
            && y >= point.y
      ...
      if (x >= point.x
          && x < (point.x + TradePanel.tileTradeBuy.getTileWidth())
          && y >= point.y
      ...
      if (x >= point.x
          && x < (point.x + TradePanel.tileTradeSell.getTileWidth())
          && y >= point.y
  ...
  private boolean isMouseOnTypingPanel(int x, int y) {
    return ((y >= TypingPanel.getPanelPoint().y
        && y < (TypingPanel.getPanelPoint().y + TypingPanel.HEIGHT))
        && (x >= TypingPanel.getPanelPoint().x
            && x < (TypingPanel.getPanelPoint().x + TypingPanel.WIDTH)));
  }
  ...
  private void loadMenus(String sCampaignID, String sMissionID) {
    ...
    SmartMenu.readXMLMenu(
        productionPanelMenu,
        "menu_production.xml",
        sCampaignID,
        sMissionID); // $NON-NLS-1$

    // Vamos a setear los tamańos de los iconos de los menús para que sea proporcional al botón de
    // menú
  ...
  private int renderBottomMenuPanel(int mouseX, int mouseY, int mousePanel, int iCurrentTexture) {
    ...
    if (mousePanel == MOUSE_BOTTOM_LEFT_SCROLL && bottomPanelItemIndex > 0) {
      UtilsGL.drawTexture(
          ...
          bottomPanelY,
          bottomPanelLeftScrollX + BOTTOM_PANEL_SCROLL_WIDTH,
          bottomPanelY + BOTTOM_PANEL_HEIGHT,
          tileBottomScrollLeftON.getTileSetTexX0(),
          tileBottomScrollLeftON.getTileSetTexY0(),
          tileBottomScrollLeftON.getTileSetTexX1(),
          tileBottomScrollLeftON.getTileSetTexY1());
    } else {
      UtilsGL.drawTexture(
          bottomPanelLeftScrollX,
          bottomPanelY,
          bottomPanelLeftScrollX + BOTTOM_PANEL_SCROLL_WIDTH,
          bottomPanelY + BOTTOM_PANEL_HEIGHT,
          tileBottomScrollLeft.getTileSetTexX0(),
          tileBottomScrollLeft.getTileSetTexY0(),
          tileBottomScrollLeft.getTileSetTexX1(),
          tileBottomScrollLeft.getTileSetTexY1());
    }
    ...
    if (mousePanel == MOUSE_BOTTOM_RIGHT_SCROLL
      ...
      UtilsGL.drawTexture(
          ...
          bottomPanelY,
          bottomPanelRightScrollX + BOTTOM_PANEL_SCROLL_WIDTH,
          bottomPanelY + BOTTOM_PANEL_HEIGHT,
          tileBottomScrollRightON.getTileSetTexX0(),
          tileBottomScrollRightON.getTileSetTexY0(),
          tileBottomScrollRightON.getTileSetTexX1(),
          tileBottomScrollRightON.getTileSetTexY1());
    } else {
      UtilsGL.drawTexture(
          bottomPanelRightScrollX,
          bottomPanelY,
          bottomPanelRightScrollX + BOTTOM_PANEL_SCROLL_WIDTH,
          bottomPanelY + BOTTOM_PANEL_HEIGHT,
          tileBottomScrollRight.getTileSetTexX0(),
          tileBottomScrollRight.getTileSetTexY0(),
          tileBottomScrollRight.getTileSetTexX1(),
          tileBottomScrollRight.getTileSetTexY1());
    }
    ...
    UtilsGL.drawTexture(
        bottomPanelX,
        bottomPanelY,
        bottomPanelX + BOTTOM_PANEL_WIDTH,
        bottomPanelY + BOTTOM_PANEL_HEIGHT,
        tileBottomPanel.getTileSetTexX0(),
        tileBottomPanel.getTileSetTexY0(),
        tileBottomPanel.getTileSetTexX1(),
    ...
    for (int i = bottomPanelItemIndex; i < bottomPanelItemIndex + BOTTOM_PANEL_NUM_ITEMS; i++) {
      ...
      if (currentMenu.getItems().get(i).getType() == SmartMenu.TYPE_MENU) {
        ...
        if (checkBlinkBottom
            && TutorialFlow.currentBlinkBottom(currentMenu.getItems().get(i).getID())) {
          UtilsGL.setColorRed();
          drawTile(
              tileBottomItemSM,
              point,
    ...
    if (bottomSubPanelMenu != null) {
      ...
      renderBackground(
          tileBottomSubPanel,
          bottomSubPanelPoint,
          BOTTOM_SUBPANEL_WIDTH,
          BOTTOM_SUBPANEL_HEIGHT);
          ...
          if (bottomSubPanelMenu.getItems().get(iMenu).getType() == SmartMenu.TYPE_MENU) {
            ...
            if (checkBlinkBottom
                && TutorialFlow.currentBlinkBottom(
                    bottomSubPanelMenu.getItems().get(iMenu).getID())) {
              UtilsGL.setColorRed();
              drawTile(
                  tileBottomItemSM,
                  point,
  ...
  private int renderLiving(LivingEntity le, int x, int y, int iType, int iCurrentTexture) {
    ...
    UtilsGL.drawTexture(
        ...
        x + le.getTileWidth(),
        y + le.getTileHeight(),
        le.getBaseTileSetTexX0(),
        le.getBaseTileSetTexY0(),
        le.getBaseTileSetTexX1(),
        le.getBaseTileSetTexY1());
    ...
    if (!bGraphiChanged) {
      ...
      if (iType == LIVINGS_PANEL_TYPE_CITIZENS || iType == LIVINGS_PANEL_TYPE_SOLDIERS) {
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_BODY)) {
          ...
          UtilsGL.drawTexture(
              x + le.getOffset_body_x(),
              y + le.getOffset_body_y(),
              x + le.getOffset_body_x() + mi.getTileWidth(),
              y + le.getOffset_body_y() + mi.getTileHeight(),
              mi.getBaseTileSetTexX0(),
              mi.getBaseTileSetTexY0(),
              mi.getBaseTileSetTexX1(),
              mi.getBaseTileSetTexY1());
        }
        if (equippedData.isWearing(MilitaryItem.LOCATION_HEAD)) {
          MilitaryItem mi = equippedData.getHead();
          iCurrentTexture = UtilsGL.setTexture(mi, iCurrentTexture);
          UtilsGL.drawTexture(
              x + le.getOffset_head_x(),
              y + le.getOffset_head_y(),
              x + le.getOffset_head_x() + mi.getTileWidth(),
              y + le.getOffset_head_y() + mi.getTileHeight(),
              mi.getBaseTileSetTexX0(),
              mi.getBaseTileSetTexY0(),
              mi.getBaseTileSetTexX1(),
              mi.getBaseTileSetTexY1());
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_FEET)) {
          ...
          iCurrentTexture = UtilsGL.setTexture(mi, iCurrentTexture);
          UtilsGL.drawTexture(
              x + le.getOffset_feet_x(),
              y + le.getOffset_feet_y(),
              x + le.getOffset_feet_x() + mi.getTileWidth(),
              y + le.getOffset_feet_y() + mi.getTileHeight(),
              mi.getBaseTileSetTexX0(),
              mi.getBaseTileSetTexY0(),
              mi.getBaseTileSetTexX1(),
              mi.getBaseTileSetTexY1());
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_LEGS)) {
          ...
          iCurrentTexture = UtilsGL.setTexture(mi, iCurrentTexture);
          UtilsGL.drawTexture(
              x + le.getOffset_legs_x(),
              y + le.getOffset_legs_y(),
              x + le.getOffset_legs_x() + mi.getTileWidth(),
              y + le.getOffset_legs_y() + mi.getTileHeight(),
              mi.getBaseTileSetTexX0(),
              mi.getBaseTileSetTexY0(),
              mi.getBaseTileSetTexX1(),
              mi.getBaseTileSetTexY1());
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_WEAPON)) {
          ...
          iCurrentTexture = UtilsGL.setTexture(mi, iCurrentTexture);
          UtilsGL.drawTexture(
              x + le.getOffset_weapon_x(),
              y + le.getOffset_weapon_y(),
              x + le.getOffset_weapon_x() + mi.getTileWidth(),
              y + le.getOffset_weapon_y() + mi.getTileHeight(),
              mi.getBaseTileSetTexX0(),
              mi.getBaseTileSetTexY0(),
              mi.getBaseTileSetTexX1(),
              mi.getBaseTileSetTexY1());
  ...
  private void renderLivingsPanel(int mouseX, int mouseY, int mousePanel) {
    ...
    if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_SOLDIERS) {
      ...
      renderBackground(
          tileLivingsGroupPanel,
          livingsGroupPanelPoint,
          LIVINGS_PANEL_GROUPS_WIDTH,
          LIVINGS_PANEL_GROUPS_HEIGHT);

      // No-group icon
      if (livingsPanelSoldiersGroupActive == -1
          || mousePanel == MOUSE_LIVINGS_PANEL_SGROUP_NOGROUP) {
      ...
      if (livingsPanelSoldiersGroupActive != -1) {
        ...
        renderBackground(
            tileLivingsGroupPanel,
            livingsSingleGroupPanelPoint,
            LIVINGS_PANEL_SINGLE_GROUP_WIDTH,
        ...
        UtilsGL.drawStringWithBorder(
            sText,
            livingsSingleGroupPanelPoint.x
                + LIVINGS_PANEL_SINGLE_GROUP_WIDTH / 2
      ...
      for (int i = 0; i < SoldierGroups.MAX_GROUPS; i++) {
        ...
        UtilsGL.drawStringWithBorder(
            sNumber,
            livingsGroupPanelFirstIconPoint.x
                + tileLivingsGroup.getTileWidth() / 2
                - UtilFont.getWidth(sNumber) / 2,
            livingsGroupPanelFirstIconPoint.y
                + (i + 1) * livingsGroupPanelIconsSeparation
                + tileLivingsGroup.getTileHeight() / 2
                - UtilFont.MAX_HEIGHT / 2,
            ColorGL.WHITE,
            ColorGL.BLACK);
      }
      ...
      // No-group icon
      if (livingsPanelCitizensGroupActive == -1
          || mousePanel == MOUSE_LIVINGS_PANEL_CGROUP_NOGROUP) {
    ...
    if ((getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
      ...
      drawTile(
          tileIconLevelUp,
          livingsPanelIconRestrictUpPoint,
          ICON_WIDTH,
          ICON_HEIGHT,
      ...
      drawTile(
          tileIconLevelDown,
          livingsPanelIconRestrictDownPoint,
          ICON_WIDTH,
          ICON_HEIGHT,
    ...
    if (iNumLivings == 0) {
      ...
      UtilsGL.drawStringWithBorder(
          sText,
          livingsPanelPoint.x + LIVINGS_PANEL_WIDTH / 2 - iTextWidth / 2,
          livingsPanelPoint.y + LIVINGS_PANEL_HEIGHT / 2 - UtilFont.MAX_HEIGHT / 2,
          ColorGL.ORANGE,
          ColorGL.BLACK);
      ...
      if ((getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
        ...
        UtilsGL.drawString(
            ...
            livingsPanelIconRestrictUpPoint.y
                + tileIconLevelUp.getTileHeight() / 2
                - UtilFont.MAX_HEIGHT / 2,
            ColorGL.BLACK);
      }
    ...
    if (iIndexPage < iNumPages) {
      ...
      drawTile(
          tileScrollDown,
          livingsPanelIconScrollDownPoint,
    ...
    for (int i = 0; i < iMaxRows; i++) {
      ...
      if (iIndex >= 0 && iIndex < alLivingIDs.size()) {
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_HEAD)) {
          ...
          drawTile(
              mi,
              livingsPanelRowHeadPoints[i].x
                  + tileBottomItem.getTileWidth() / 2
                  - mi.getTileWidth() / 2,
              livingsPanelRowHeadPoints[i].y
                  + tileBottomItem.getTileHeight() / 2
                  - mi.getTileHeight() / 2,
              false);
        } else {
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_BODY)) {
          ...
          drawTile(
              mi,
              livingsPanelRowBodyPoints[i].x
                  + tileBottomItem.getTileWidth() / 2
                  - mi.getTileWidth() / 2,
              livingsPanelRowBodyPoints[i].y
                  + tileBottomItem.getTileHeight() / 2
                  - mi.getTileHeight() / 2,
              false);
        } else {
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_LEGS)) {
          ...
          drawTile(
              mi,
              livingsPanelRowLegsPoints[i].x
                  + tileBottomItem.getTileWidth() / 2
                  - mi.getTileWidth() / 2,
              livingsPanelRowLegsPoints[i].y
                  + tileBottomItem.getTileHeight() / 2
                  - mi.getTileHeight() / 2,
              false);
        } else {
        ...
        if (equippedData.isWearing(MilitaryItem.LOCATION_FEET)) {
          ...
          drawTile(
              mi,
              livingsPanelRowFeetPoints[i].x
                  + tileBottomItem.getTileWidth() / 2
                  - mi.getTileWidth() / 2,
              livingsPanelRowFeetPoints[i].y
                  + tileBottomItem.getTileHeight() / 2
                  - mi.getTileHeight() / 2,
              false);
        } else {
        ...
        if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
            || getLivingsPanelActive() == LIVINGS_PANEL_TYPE_SOLDIERS) {
          if (pItem != null
              && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_AUTOEQUIP
              && pItem.y == i) {
            iCurrentTexture = UtilsGL.setTexture(tileLivingsRowAutoequipON, iCurrentTexture);
        ...
        if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS) {
          if (pItem != null
              && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER
              && pItem.y == i) {
            ...
            drawTile(
                tileLivingsRowConvertSoldierON,
                livingsPanelRowConvertCivilianSoldierPoints[i]);
            if (tutorialFlow != null && tutorialFlow.isBlinkMiniLivingsConvertSoldier()) {
              UtilsGL.unsetColor();
            }
          } else {
          ...
          if (livingsPanelCitizensGroupActive == -1) {
            if (pItem != null
                && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_PROFESSIONS
                && pItem.y == i) {
          ...
          if (pItem != null
              && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_JOBS_GROUPS_ADDREMOVE
              && pItem.y == i) {
          ...
          if (pItem != null
              && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_CIVILIAN
              && pItem.y == i) {
            ...
            drawTile(
                tileLivingsRowConvertCivilianON,
                livingsPanelRowConvertCivilianSoldierPoints[i]);
            if (tutorialFlow != null && tutorialFlow.isBlinkMiniLivingsConvertCivilian()) {
              UtilsGL.unsetColor();
            }
          ...
          if (livingsPanelSoldiersGroupActive == -1) {
            if (soldierState == SoldierData.STATE_GUARD
                || (pItem != null
                    && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER_GUARD
                    && pItem.y == i)) {
              ...
              drawTile(
                  tileLivingsRowConvertSoldierGuardON,
                  livingsPanelRowConvertSoldierGuardPoints[i]);
              if (tutorialFlow != null && tutorialFlow.isBlinkMiniLivingsGuard()) {
                UtilsGL.unsetColor();
              }
            } else {
              ...
              drawTile(
                  tileLivingsRowConvertSoldierGuard,
                  livingsPanelRowConvertSoldierGuardPoints[i]);
              if (tutorialFlow != null && tutorialFlow.isBlinkMiniLivingsGuard()) {
                UtilsGL.unsetColor();
              }
            ...
            if (soldierState == SoldierData.STATE_PATROL
                || (pItem != null
                    && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER_PATROL
                    && pItem.y == i)) {
              ...
              drawTile(
                  tileLivingsRowConvertSoldierPatrolON,
              ...
              drawTile(
                  tileLivingsRowConvertSoldierPatrol,
                  livingsPanelRowConvertSoldierPatrolPoints[i]);
              if (tutorialFlow != null && tutorialFlow.isBlinkMiniLivingsPatrol()) {
                UtilsGL.unsetColor();
              }
            }
            if (soldierState == SoldierData.STATE_BOSS_AROUND
                || (pItem != null
                    && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_CONVERT_SOLDIER_BOSS
                    && pItem.y == i)) {
              ...
              drawTile(
                  tileLivingsRowConvertSoldierBossON,
                  livingsPanelRowConvertSoldierBossPoints[i]);
              if (tutorialFlow != null && tutorialFlow.isBlinkMiniLivingsBoss()) {
                UtilsGL.unsetColor();
              }
            } else {
              ...
              drawTile(
                  tileLivingsRowConvertSoldierBoss,
                  livingsPanelRowConvertSoldierBossPoints[i]);
              if (tutorialFlow != null && tutorialFlow.isBlinkMiniLivingsBoss()) {
                UtilsGL.unsetColor();
              }
            ...
            if (soldierState == SoldierData.STATE_IN_A_GROUP
                || (pItem != null
                    && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_SGROUP_ADD
                    && pItem.y == i)) {
            ...
            if (pItem != null
                && pItem.x == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_SGROUP_REMOVE
                && pItem.y == i) {
    ...
    UtilsGL.drawString(
        sText,
        livingsPanelPagesPoint.x - UtilFont.getWidth(sText) / 2,
        livingsPanelPagesPoint.y,
        ColorGL.BLACK);
  ...
  private void renderMatsPanel(int mouseX, int mouseY, int mousePanel) {
    ...
    renderBackground(
        tileMatsPanelSubPanel,
        matsPanelSubPanelPoint,
        MATS_PANEL_SUBPANEL_WIDTH,
    ...
    for (int i = 0; i < MatsPanelData.numGroups; i++) {
      if (i == getMatsPanelActive()) {
        ...
        drawTile(
            matsPanelTilesON[i],
            matsPanelIconPoints[i].x
                + tileBottomItem.getTileWidth() / 2
                - matsPanelTilesON[i].getTileWidth() / 2,
            matsPanelIconPoints[i].y
                + tileBottomItem.getTileHeight() / 2
    ...
    for (int i = 0; i < iMax; i++) {
      if (MatsPanelData.tileGroups.get(getMatsPanelActive()).size() > (i + iIndex)) {
        ...
        iCurrentTexture = UtilsGL.setTexture(tile, iCurrentTexture);
        // drawTile (tile, matsPanelItemPoints [i].x + tileBottomItem.getTileWidth () / 2 -
        // tile.getTileWidth () / 2, matsPanelItemPoints [i].y + tileBottomItem.getTileHeight () / 2
        // - tile.getTileHeight () / 2, false); //BOTTOM_ITEM_WIDTH, BOTTOM_ITEM_HEIGHT, false);
        drawTile(
            tile,
            matsPanelItemPoints[i].x + tileBottomItem.getTileWidth() / 2 - tile.getTileWidth() / 2,
            matsPanelItemPoints[i].y + tileBottomItem.getTileHeight() / 2 - BOTTOM_ITEM_HEIGHT / 2,
            BOTTOM_ITEM_WIDTH,
            BOTTOM_ITEM_HEIGHT,
            false); // BOTTOM_ITEM_WIDTH, BOTTOM_ITEM_HEIGHT, false);
      }
    }
    UtilsGL.glEnd();
    ...
    for (int i = 0; i < iMax; i++) {
      if (MatsPanelData.tileGroups.get(getMatsPanelActive()).size() > (i + iIndex)) {
        ...
        sText = Integer.toString(
            Item.getNumItems(
                UtilsIniHeaders.getIntIniHeader(tile.getIniHeader()),
                false,
                World.MAP_DEPTH));
        UtilsGL.drawStringWithBorder(
            sText,
            matsPanelItemPoints[i].x
                + tileBottomItem.getTileWidth() / 2
                - UtilFont.getWidth(sText) / 2,
            matsPanelItemPoints[i].y + tileBottomItem.getTileHeight() - UtilFont.MAX_HEIGHT,
            ColorGL.WHITE,
            ColorGL.BLACK);
      }
    }
    ...
    // Pages
    sText = (matsIndexPages[getMatsPanelActive()] + 1)
        + " / "
        + matsNumPages[getMatsPanelActive()]; // $NON-NLS-1$
    UtilsGL.drawString(
        sText,
        matsPanelPagesPositionPoint.x - UtilFont.getWidth(sText) / 2,
        matsPanelPagesPositionPoint.y,
        ColorGL.BLACK);
    UtilsGL.glEnd();
  }
  ...
  private void renderMenuPanel(int mouseX, int mouseY, int mousePanel) {
    ...
    if (isMenuPanelLocked()) {
      ...
      drawTile(
          tileOpenRightMenuON,
          tileOpenCloseRightMenuPoint,
          tileOpenRightMenuON.getTileWidth(),
          tileOpenRightMenuON.getTileHeight(),
          mousePanel == MOUSE_MENU_OPENCLOSE);
      UtilsGL.glEnd();
    } else {
      // XAVI GL11.glColor4f (1, 1, 1, 1);
      ...
      drawTile(
          tileOpenRightMenu,
          tileOpenCloseRightMenuPoint,
          tileOpenRightMenu.getTileWidth(),
          tileOpenRightMenu.getTileHeight(),
          mousePanel == MOUSE_MENU_OPENCLOSE);
      if (checkBlinkRight) {
        UtilsGL.unsetColor();
      }
  ...
  private void renderMessagesPanel(int mouseX, int mouseY, int mousePanel) {
    ...
    if (MessagesPanel.TYPE_ANNOUNCEMENT == iMessagesType) {
      ...
      drawTile(
          messagePanelTilesON[MessagesPanel.TYPE_ANNOUNCEMENT],
          messagePanelIconPoints[MessagesPanel.TYPE_ANNOUNCEMENT],
    ...
    if (MessagesPanel.TYPE_COMBAT == iMessagesType) {
      ...
      drawTile(
          messagePanelTilesON[MessagesPanel.TYPE_COMBAT],
          messagePanelIconPoints[MessagesPanel.TYPE_COMBAT],
    ...
    if (MessagesPanel.TYPE_HEROES == iMessagesType) {
      ...
      drawTile(
          messagePanelTilesON[MessagesPanel.TYPE_HEROES],
          messagePanelIconPoints[MessagesPanel.TYPE_HEROES],
    ...
    if (MessagesPanel.TYPE_SYSTEM == iMessagesType) {
      ...
      drawTile(
          messagePanelTilesON[MessagesPanel.TYPE_SYSTEM],
          messagePanelIconPoints[MessagesPanel.TYPE_SYSTEM],
    ...
    renderBackground(
        tileMessagesPanelSubPanel,
        messagesPanelSubPanelPoint,
        MESSAGES_PANEL_SUBPANEL_WIDTH,
        MESSAGES_PANEL_SUBPANEL_HEIGHT);

    UtilsGL.glEnd();

    // Pages
    String sText = MessagesPanel.getPagesCurrent(iMessagesType)
        + " / "
        + MessagesPanel.getPages(iMessagesType); // $NON-NLS-1$
    // XAVI GL11.glColor4f (1, 1, 1, 1);
    GL11.glBindTexture(GL11.GL_TEXTURE_2D, Game.TEXTURE_FONT_ID);
    GL11.glTexEnvf(GL11.GL_TEXTURE_ENV, GL11.GL_TEXTURE_ENV_MODE, GL11.GL_MODULATE);
    UtilsGL.glBegin(GL11.GL_QUADS);
    UtilsGL.drawString(
        sText,
        messagePanelPagesPositionPoint.x - UtilFont.getWidth(sText) / 2,
        messagePanelPagesPositionPoint.y,
        ColorGL.BLACK);
    UtilsGL.glEnd();
  ...
  private void renderPilePanel(int mouseX, int mouseY, int mousePanel) {
    ...
    if (menuPile != null) {
      ...
      for (int i = 0; i < iMaxItems; i++) {
        ...
        if (smAux.getType() == SmartMenu.TYPE_MENU) {
          ...
          drawTile(
              tileBottomItemSM,
              pilePanelItemPoints[i].x
                  + tileBottomItemSM.getTileWidth() / 2
                  - tileBottomItemSM.getTileWidth() / 2,
              pilePanelItemPoints[i].y
        ...
        if (smAux.getCommand() != null
            && (smAux.getCommand().equals(CommandPanel.COMMAND_STOCKPILE_ENABLE_ITEM)
    ...
    drawTile(
        tileConfigCopy,
        pilePanelIconConfigCopyPoint.x,
        pilePanelIconConfigCopyPoint.y,
    ...
    if (pilePanelIsLocked) {
      ...
      drawTile(
          tileConfigLockLocked,
          pilePanelIconConfigLockPoint.x,
          pilePanelIconConfigLockPoint.y,
    ...
    drawTile(
        tileConfigLockAll,
        pilePanelIconConfigLockAllPoint.x,
        pilePanelIconConfigLockAllPoint.y,
    ...
    drawTile(
        tileConfigUnlockAll,
        pilePanelIconConfigUnlockAllPoint.x,
        pilePanelIconConfigUnlockAllPoint.y,
    ...
    UtilsGL.drawString(
        sText,
        pilePanelPagesPositionPoint.x - UtilFont.getWidth(sText) / 2,
        pilePanelPagesPositionPoint.y,
        ColorGL.BLACK);
      ...
      for (int i = 0; i < iMaxItems; i++) {
        ...
        if (smAux.getType() == SmartMenu.TYPE_ITEM) {
          if (smAux.getCommand().equals(CommandPanel.COMMAND_STOCKPILE_ENABLE_ITEM)
            ...
            int iNumItems = Item.getNumItems(
                UtilsIniHeaders.getIntIniHeader(smAux.getParameter()),
                false,
                World.MAP_DEPTH);
            ...
            int iNumItems = Item.getNumItems(
                UtilsIniHeaders.getIntIniHeader(smAux.getParameter2()),
                false,
                World.MAP_DEPTH);
            sText = Integer.toString(iNumItems);
            UtilsGL.drawStringWithBorder(
    ...
    UtilsGL.drawStringWithBorder(
        sTitle,
        pilePanelPoint.x + tileMatsPanel[3].getTileWidth(),
        pilePanelPoint.y + UtilFont.MAX_HEIGHT,
        ColorGL.ORANGE,
        ColorGL.BLACK);
  ...
  private void renderPrioritiesPanel(int mouseX, int mouseY, int mousePanel) {
    ...
    renderBackground(
        tilePrioritiesPanel,
        prioritiesPanelPoint,
        PRIORITIES_PANEL_WIDTH,
        PRIORITIES_PANEL_HEIGHT);

    // Items
    Point point;
    Point pItem;
    if (mousePanel == MOUSE_PRIORITIES_PANEL_ITEMS
        || mousePanel == MOUSE_PRIORITIES_PANEL_ITEMS_UP
    ...
    for (int i = 0; i < PRIORITIES_PANEL_NUM_ITEMS; i++) {
      ...
      if (i < (PRIORITIES_PANEL_NUM_ITEMS - 1)) {
        ...
        Tile tile = ActionPriorityManager.getItem(ActionPriorityManager.getPrioritiesList().get(i))
            .getIcon();
        iCurrentTexture = UtilsGL.setTexture(tile, iCurrentTexture);
        drawTile(
            tile,
  ...
  private void renderProductionPanel(int mouseX, int mouseY, int mousePanel) {
          ...
          for (int x = 0; x < PRODUCTION_PANEL_NUM_ITEMS_X; x++) {
            ...
            if (bBlinkItem
                ...
                && ImagesPanel.getCurrentFlowIndex() < Game.getCurrentMissionData().getTutorialFlows()
                    .size()) {
              tutFlow = Game.getCurrentMissionData()
                  .getTutorialFlows()
            ...
            if (point.x != -1) {
              ...
              drawTile(
                  ...
                  ICON_HEIGHT,
                  (pItem != null
                      && pItem.x == MOUSE_PRODUCTION_PANEL_ITEMS_PLUS_REGULAR
                      && pItem.y == iMenu));
              if (tutFlow != null && tutFlow.isBlinkProductionRegularPlus()) {
                UtilsGL.unsetColor();
              }
              ...
              drawTile(
                  tileProductionPanelPlusIcon,
                  productionPanelItemsPlusAutomatedPosition.get(iMenu),
                  ICON_WIDTH,
                  ICON_HEIGHT,
                  (pItem != null
                      && pItem.x == MOUSE_PRODUCTION_PANEL_ITEMS_PLUS_AUTOMATED
                      && pItem.y == iMenu));
              if (tutFlow != null && tutFlow.isBlinkProductionAutomatedPlus()) {
                UtilsGL.unsetColor();
              }
              ...
              drawTile(
                  ...
                  productionPanelItemsMinusRegularPosition.get(iMenu),
                  ICON_WIDTH,
                  ICON_HEIGHT,
                  (pItem != null
                      && pItem.x == MOUSE_PRODUCTION_PANEL_ITEMS_MINUS_REGULAR
                      && pItem.y == iMenu));
              if (tutFlow != null && tutFlow.isBlinkProductionRegularMinus()) {
                UtilsGL.unsetColor();
              }
              ...
              drawTile(
                  tileProductionPanelMinusIcon,
                  productionPanelItemsMinusAutomatedPosition.get(iMenu),
                  ICON_WIDTH,
                  ICON_HEIGHT,
                  (pItem != null
                      && pItem.x == MOUSE_PRODUCTION_PANEL_ITEMS_MINUS_AUTOMATED
                      && pItem.y == iMenu));
              if (tutFlow != null && tutFlow.isBlinkProductionAutomatedMinus()) {
                UtilsGL.unsetColor();
              }
    ...
    if (isProductionPanelLocked()) {
      ...
      drawTile(
          tileOpenProductionPanelON,
          tileOpenCloseProductionPanelPoint,
          tileOpenProductionPanelON.getTileWidth(),
          tileOpenProductionPanelON.getTileHeight(),
      ...
      drawTile(
          ...
          tileOpenCloseProductionPanelPoint,
          tileOpenProductionPanel.getTileWidth(),
          tileOpenProductionPanel.getTileHeight(),
          mousePanel == MOUSE_PRODUCTION_OPENCLOSE);
      if (checkBlinkProduction) {
        UtilsGL.unsetColor();
      }
  ...
  private void renderProfessionsPanel(int mouseX, int mouseY, int mousePanel) {
    ...
    if ((professionsPanelPageIndex + 1) < professionsPanelMaxPages) {
      ...
      drawTile(
          tileScrollDown,
          professionsPanelIconScrollDownPoint,
    ...
    if (menuProfessions != null) {
      ...
      for (int i = 0; i < iMaxItems; i++) {
        ...
        if (smAux.getType() == SmartMenu.TYPE_MENU) {
          ...
          drawTile(
              tileBottomItemSM,
              professionsPanelItemPoints[i].x
                  + tileBottomItemSM.getTileWidth() / 2
                  - tileBottomItemSM.getTileWidth() / 2,
              professionsPanelItemPoints[i].y
                  + tileBottomItemSM.getTileHeight() / 2
                  - tileBottomItemSM.getTileHeight() / 2,
              (pItem != null && pItem.y == i));
        } else {
    ...
    UtilsGL.drawString(
        sText,
        professionsPanelPagesPositionPoint.x - UtilFont.getWidth(sText) / 2,
        professionsPanelPagesPositionPoint.y,
        ColorGL.BLACK);

    // Title
    if (professionsPanelIsCitizen) {
      UtilsGL.drawStringWithBorder(
          Messages.getString("UIPanel.63"),
          professionsPanelPoint.x + tileMatsPanel[3].getTileWidth(),
          professionsPanelPoint.y + UtilFont.MAX_HEIGHT,
          ColorGL.ORANGE,
          ColorGL.BLACK); // $NON-NLS-1$
    } else {
      UtilsGL.drawStringWithBorder(
          Messages.getString("UIPanel.67"),
          professionsPanelPoint.x + tileMatsPanel[3].getTileWidth(),
          professionsPanelPoint.y + UtilFont.MAX_HEIGHT,
          ColorGL.ORANGE,
          ColorGL.BLACK); // $NON-NLS-1$
  ...
  private void renderTask() {
    ...
    UtilsGL.drawTexture(
        ...
        taskX + taskWidth + 2,
        taskY + taskHeight + 2,
        UIPanel.BLACK_TILE.getTileSetTexX0(),
        UIPanel.BLACK_TILE.getTileSetTexY0(),
        UIPanel.BLACK_TILE.getTileSetTexX1(),
        UIPanel.BLACK_TILE.getTileSetTexY1());
    UtilsGL.glEnd();
  ...
  private void renderTooltip(int x, int y, int mousePanel) {
    if (mousePanel == MOUSE_NONE
        || mousePanel == MOUSE_PRODUCTION_PANEL
    ...
    if (typingPanel != null) {
      ...
      if (isBottomMenuPanelActive()) {
        if (mousePanel == MOUSE_BOTTOM_ITEMS) {
          ...
          if (iItem != -1) {
            ...
            if (item.getType() == SmartMenu.TYPE_ITEM
                && (iItem + bottomPanelItemIndex) >= 0
      ...
      if (tooltip == null && isTradePanelActive()) {
        ...
        if (!bTrading && mousePanel == MOUSE_TRADE_PANEL_BUTTONS_CARAVAN) {
          Point p = isMouseOnTradeButtons(x, y);
          if (p != null
              && p.x == MOUSE_TRADE_PANEL_BUTTONS_CARAVAN
              && (p.y + tradePanel.getIndexButtonsCaravan()) < tradePanel.getMenuCaravan().getItems()
                  .size()) {
            tooltip = tradePanel
                .getMenuCaravan()
                .getItems()
                .get(p.y + tradePanel.getIndexButtonsCaravan())
                .getName();
            tooltipX = x + 32;
            tooltipY = y;
          }
          ...
          if (caravanData != null) {
            Point p = isMouseOnTradeButtons(x, y);
            if (p != null
                && p.x == MOUSE_TRADE_PANEL_BUTTONS_TO_BUY_CARAVAN
                && (p.y + tradePanel.getIndexButtonsToBuyCaravan()) < caravanData.getMenuCaravanToBuy()
                    .getItems().size()) {
              tooltip = caravanData
                  .getMenuCaravanToBuy()
                  .getItems()
                  .get(p.y + tradePanel.getIndexButtonsToBuyCaravan())
                  .getName();
              tooltipX = x + 32;
              tooltipY = y;
            }
          ...
          Point p = isMouseOnTradeButtons(x, y);
          if (p != null
              && p.x == MOUSE_TRADE_PANEL_BUTTONS_TOWN
              && (p.y + tradePanel.getIndexButtonsTown()) < tradePanel.getMenuTown().getItems().size()) {
            tooltip = tradePanel
                .getMenuTown()
                .getItems()
                .get(p.y + tradePanel.getIndexButtonsTown())
                .getName();
            tooltipX = x + 32;
            tooltipY = y;
          }
          ...
          if (caravanData != null) {
            Point p = isMouseOnTradeButtons(x, y);
            if (p != null
                && p.x == MOUSE_TRADE_PANEL_BUTTONS_TO_SELL_TOWN
                && (p.y + tradePanel.getIndexButtonsToSellTown()) < caravanData.getMenuTownToSell()
                    .getItems().size()) {
              tooltip = caravanData
                  .getMenuTownToSell()
                  .getItems()
                  .get(p.y + tradePanel.getIndexButtonsToSellTown())
                  .getName();
              tooltipX = x + 32;
              tooltipY = y;
            }
      ...
      if (tooltip == null && isMatsPanelActive()) {
        if (mousePanel == MOUSE_MATS_PANEL_BUTTONS_GROUPS) {
          ...
          if (p != null
              && p.y > -1
              && p.y < MatsPanelData.tileGroups.get(getMatsPanelActive()).size()) {
      ...
      if (tooltip == null && isLivingsPanelActive()) {
        if (mousePanel == MOUSE_LIVINGS_PANEL_BUTTONS_CLOSE) {
          ...
          tooltip = Messages.getString("UIPanel.66")
              + " ("
              + Game.getWorld().getCitizenGroups().getCitizensWithoutGroup().size()
          ...
          tooltip = Messages.getString("UIPanel.53")
              + " ("
              + Game.getWorld().getSoldierGroups().getSoldiersWithoutGroup().size()
              + ")"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
          tooltipX = x - UtilFont.getWidth(tooltip) / 2;
          tooltipY = y - UtilFont.MAX_HEIGHT - 2;
              ...
              if (mousePanel == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS) {
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (citizen.getCurrentTask() != null) {
                    alMessages.add(
                        Messages.getString("Citizen.7") + citizen.getCurrentTask()); // $NON-NLS-1$
                    alColors.add(ColorGL.WHITE);
                  }
                  ...
                  if (citizen.getSoldierData().isSoldier()) {
                    alMessages.add(
                        Messages.getString("Hero.4")
                            + citizen.getSoldierData().getLevel()
                            + " ("
                            + citizen.getSoldierData().getXp()
                            + Messages.getString("Hero.5")
                            + citizen.getSoldierData().getXpPCT()
                            + "%)"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                    // //$NON-NLS-4$
                    alColors.add(ColorGL.WHITE);
                  }
                  ...
                  alMessages.add(
                      Messages.getString("UIPanel.40")
                          + citizen.getCitizenData().getHappiness()
                          + " / 100"); //$NON-NLS-1$ //$NON-NLS-2$
                  alColors.add(ColorGL.WHITE);
                  alMessages.add(
                      Messages.getString("UIPanel.49")
                          + citizen.getCitizenData().getHungry()
                          + " / "
                          + citizen.getCitizenData().getMaxHungry()); // $NON-NLS-1$
                  // //$NON-NLS-2$
                  alColors.add(ColorGL.WHITE);
                  alMessages.add(
                      Messages.getString("UIPanel.52")
                          + citizen.getCitizenData().getSleep()
                          + " / "
                  ...
                  alMessages.add(
                      Messages.getString("Hero.4")
                          + hero.getHeroData().getLevel()
                          + " ("
                          + hero.getHeroData().getXp()
                          + Messages.getString("Hero.5")
                          + hero.getHeroData().getXpPCT()
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                    || getLivingsPanelActive() == LIVINGS_PANEL_TYPE_SOLDIERS) {
                  if (equippedData.isWearing(MilitaryItem.LOCATION_HEAD)) {
                    tooltip = Messages.getString("UIPanel.41")
                        + equippedData.getHead().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                    tooltip = Messages.getString("UIPanel.42"); // $NON-NLS-1$
                  }
                } else {
                  if (equippedData.isWearing(MilitaryItem.LOCATION_HEAD)) {
                    tooltip = Messages.getString("Citizen.21")
                        + equippedData.getHead().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (equippedData.isWearing(MilitaryItem.LOCATION_BODY)) {
                    tooltip = Messages.getString("UIPanel.41")
                        + equippedData.getBody().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                    tooltip = Messages.getString("UIPanel.44"); // $NON-NLS-1$
                  }
                } else {
                  if (equippedData.isWearing(MilitaryItem.LOCATION_BODY)) {
                    tooltip = Messages.getString("Citizen.22")
                        + equippedData.getBody().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (equippedData.isWearing(MilitaryItem.LOCATION_LEGS)) {
                    tooltip = Messages.getString("UIPanel.41")
                        + equippedData.getLegs().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                    tooltip = Messages.getString("UIPanel.46"); // $NON-NLS-1$
                  }
                } else {
                  if (equippedData.isWearing(MilitaryItem.LOCATION_LEGS)) {
                    tooltip = Messages.getString("Citizen.23")
                        + equippedData.getLegs().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (equippedData.isWearing(MilitaryItem.LOCATION_FEET)) {
                    tooltip = Messages.getString("UIPanel.41")
                        + equippedData.getFeet().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                    tooltip = Messages.getString("UIPanel.48"); // $NON-NLS-1$
                  }
                } else {
                  if (equippedData.isWearing(MilitaryItem.LOCATION_FEET)) {
                    tooltip = Messages.getString("Citizen.24")
                        + equippedData.getFeet().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                ...
                if (getLivingsPanelActive() == LIVINGS_PANEL_TYPE_CITIZENS
                  ...
                  if (equippedData.isWearing(MilitaryItem.LOCATION_WEAPON)) {
                    tooltip = Messages.getString("UIPanel.41")
                        + equippedData.getWeapon().getExtendedTilename(); // $NON-NLS-1$
                  } else {
                    tooltip = Messages.getString("UIPanel.50"); // $NON-NLS-1$
                  }
                } else {
                  if (equippedData.isWearing(MilitaryItem.LOCATION_WEAPON)) {
                    tooltip = Messages.getString("Citizen.25")
                        + equippedData.getWeapon().getExtendedTilename(); // $NON-NLS-1$
                  } else {
      ...
      if (tooltip == null) {
        if (mousePanel == MOUSE_DATEPANEL) {
          ...
          tooltipX = datePanelPoint.x
              + tileDatePanel.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = datePanelPoint.y + tileDatePanel.getTileHeight();
        } else if (mousePanel == MOUSE_ICON_LEVEL_UP) {
          tooltip = Messages.getString("UIPanel.0")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_LEVEL_UP); // $NON-NLS-1$
          tooltipX = iconLevelUpPoint.x
              + tileIconLevelUp.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconLevelUpPoint.y - UtilFont.MAX_HEIGHT;
        } else if (mousePanel == MOUSE_ICON_LEVEL_DOWN) {
          tooltip = Messages.getString("UIPanel.2")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_LEVEL_DOWN); // $NON-NLS-1$
          tooltipX = iconLevelDownPoint.x
              + tileIconLevelDown.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          ...
          tooltipX = iconLevelPoint.x
              + tileIconLevel.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconLevelPoint.y + UtilFont.MAX_HEIGHT * 2;
        } else if (mousePanel == MOUSE_ICON_CITIZEN_PREVIOUS) {
          tooltip = Messages.getString("UIPanel.3")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_PREVIOUS_CITIZEN); // $NON-NLS-1$
          tooltipX = iconCitizenPreviousPoint.x
              + tileIconCitizenPrevious.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconCitizenPreviousPoint.y + tileBottomItem.getTileHeight();
        } else if (mousePanel == MOUSE_ICON_CITIZEN_NEXT) {
          tooltip = Messages.getString("UIPanel.4")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_NEXT_CITIZEN); // $NON-NLS-1$
          tooltipX = iconCitizenNextPoint.x
              + tileIconCitizenNext.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconCitizenNextPoint.y + tileBottomItem.getTileHeight();
        } else if (mousePanel == MOUSE_ICON_SOLDIER_PREVIOUS) {
          tooltip = Messages.getString("UIPanel.5")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_PREVIOUS_SOLDIER); // $NON-NLS-1$
          tooltipX = iconSoldierPreviousPoint.x
              + tileIconSoldierPrevious.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconSoldierPreviousPoint.y + tileBottomItem.getTileHeight();
        } else if (mousePanel == MOUSE_ICON_SOLDIER_NEXT) {
          tooltip = Messages.getString("UIPanel.6")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_NEXT_SOLDIER); // $NON-NLS-1$
          tooltipX = iconSoldierNextPoint.x
              + tileIconSoldierNext.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconSoldierNextPoint.y + tileBottomItem.getTileHeight();
        } else if (mousePanel == MOUSE_ICON_HERO_PREVIOUS) {
          tooltip = Messages.getString("UIPanel.22")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_PREVIOUS_HERO); // $NON-NLS-1$
          tooltipX = iconHeroPreviousPoint.x
              + tileIconHeroPrevious.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconHeroPreviousPoint.y + tileBottomItem.getTileHeight();
        } else if (mousePanel == MOUSE_ICON_HERO_NEXT) {
          tooltip = Messages.getString("UIPanel.23")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_NEXT_HERO); // $NON-NLS-1$
          tooltipX = iconHeroNextPoint.x
              + tileIconHeroNext.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          ...
          tooltipX = iconNumCitizensBackgroundPoint.x
              + tileBottomItem.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          ...
          tooltipX = iconNumSoldiersBackgroundPoint.x
              + tileBottomItem.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          ...
          tooltipX = iconNumHeroesBackgroundPoint.x
              + tileBottomItem.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconNumHeroesBackgroundPoint.y + tileBottomItem.getTileHeight();
        } else if (mousePanel == MOUSE_INFO_CARAVAN) {
          tooltip = Messages.getString("UIPanel.25")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_SHOW_TRADE); // $NON-NLS-1$
          tooltipX = iconCaravanBackgroundPoint.x
              + tileBottomItem.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconCaravanBackgroundPoint.y + tileBottomItem.getTileHeight();
        } else if (mousePanel == MOUSE_ICON_PRIORITIES) {
          tooltip = Messages.getString("UIPanel.14")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_SHOW_PRIORITIES); // $NON-NLS-1$
          tooltipX = iconPrioritiesPoint.x
              + tileIconPriorities.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconPrioritiesPoint.y + UtilFont.MAX_HEIGHT * 2;
        } else if (mousePanel == MOUSE_ICON_MATS) {
          tooltip = Messages.getString("UIPanel.32")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_SHOW_STOCK); // $NON-NLS-1$
          ...
          tooltip = Messages.getString("UIPanel.12")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_TOGGLE_GRID); // $NON-NLS-1$
          ...
          tooltip = Messages.getString("UIPanel.16")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_TOGGLE_MINIBLOCKS); // $NON-NLS-1$
          tooltipX = iconMiniblocksPoint.x
          ...
          tooltip = Messages.getString("UIPanel.45")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_TOGGLE_FLAT_MOUSE); // $NON-NLS-1$
          tooltipX = iconFlatMousePoint.x
              + tileIconFlatMouse.getTileWidth() / 2
              - (UtilFont.getWidth(tooltip) / 2);
          tooltipY = iconFlatMousePoint.y + UtilFont.MAX_HEIGHT * 2;
        } else if (mousePanel == MOUSE_ICON_3DMOUSE) {
          tooltip = Messages.getString("UtilsKeyboard.16")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_TOGGLE_3D_MOUSE); // $NON-NLS-1$
          tooltipX = icon3DMousePoint.x
          ...
          tooltip = Messages.getString("UIPanel.10")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_PAUSE); // $NON-NLS-1$
          tooltipX = iconPauseResumePoint.x
          ...
          tooltip = Messages.getString("UIPanel.1")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_SPEED_DOWN); // $NON-NLS-1$
          tooltipX = iconLowerSpeedPoint.x
          ...
          tooltip = Messages.getString("UIPanel.15")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_SPEED_UP); // $NON-NLS-1$
          tooltipX = iconIncreaseSpeedPoint.x
          ...
          tooltip = Messages.getString("UIPanel.75")
              + UtilsKeyboard.getTooltip(UtilsKeyboard.FN_SHOW_MISSION); // $NON-NLS-1$
          tooltipX = x + 32;
          tooltipY = y;
      ...
      if (mousePanel == MOUSE_MESSAGES_ICON_ANNOUNCEMENT) {
        ...
        if (alEvents.size() == 0) {
          ...
          UtilsGL.drawTooltip(
              tooltip,
              iconEventsPoint.x
                  + GlobalEventData.getIcon().getTileWidth() / 2
                  - UtilFont.getWidth(tooltip) / 2,
              iconEventsPoint.y + GlobalEventData.getIcon().getTileHeight(),
              renderWidth,
              renderHeight);
        } else {
          // Obtenemos el tamańo del tooltip
          ...
          for (int i = 0; i < alEvents.size(); i++) {
            ...
            if (emi != null) {
              ...
              if (emi.getIcon() != null) {
                UtilsGL.drawString(
                    emi.getName(),
                    tooltipX + emi.getIcon().getTileWidth() + 4,
        ...
        // UtilsGL.drawTooltip (tooltip, iconGodsPoint.x + tileIconGods.getTileWidth () / 2 -
        // UtilFont.getWidth (tooltip) / 2, iconGodsPoint.y + tileIconGods.getTileHeight (),
        ...
        // GL11.glBindTexture (GL11.GL_TEXTURE_2D, UIPanel.tileTooltipBackground.getTextureID ());
        // UtilsGL.glBegin (GL11.GL_QUADS);
        // UtilsGL.drawTexture (tooltipX, tooltipY - 4, tooltipX + tooltipWidth + 8, tooltipY +
        // tooltipHeight + 4, UIPanel.tileTooltipBackground.getTileSetTexX0 (),
        // UIPanel.tileTooltipBackground.getTileSetTexY0 (),
        // UIPanel.tileTooltipBackground.getTileSetTexX1 (),
        // UIPanel.tileTooltipBackground.getTileSetTexY1 ());
        // UtilsGL.glEnd ();
        ...
        //
        // if (Game.DEBUG_MODE) {
        // UtilsGL.drawString (gd.getFullName () + " (" + gd.getStatus () + ")", tooltipX,
        // iCurrentHeight); //$NON-NLS-1$ //$NON-NLS-2$
        // } else {
  ...
  private void renderTradePanel(int mouseX, int mouseY, int mousePanel) {
    ...
    if (caravanData == null || caravanData.getStatus() == CaravanData.STATUS_NONE) {
      ...
      Log.log(
          Log.LEVEL_ERROR,
          "Caravan status [" + caravanData.getStatus() + "]",
          "UIPanel"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
      sText = null;
    }
    ...
    if (sText != null && !bTrading) {
      ...
      UtilsGL.drawStringWithBorder(
          sText,
          tradePanelPoint.x + TRADE_PANEL_WIDTH / 2 - iTextWidth / 2,
          tradePanelPoint.y + TRADE_PANEL_HEIGHT / 2 - UtilFont.MAX_HEIGHT / 2,
          ColorGL.ORANGE,
          ColorGL.BLACK);
      UtilsGL.glEnd();
      return;
    ...
    if (!bTrading) {
      ...
      if (tradePanel.isTransactionReady()) {
        drawTile(
            TradePanel.tileTradeConfirm,
            tradePanel.getConfirmPoint(),
            TradePanel.tileTradeConfirm.getTileWidth(),
            TradePanel.tileTradeConfirm.getTileHeight(),
    ...
    if (!bTrading) {
      ...
      for (int i = 0; i < tradePanel.getAlButtonPointsCaravan().size(); i++) {
        point = tradePanel.getAlButtonPointsCaravan().get(i);
        drawTile(
            TradePanel.tileTradeButton,
            point,
            TradePanel.tileTradeButton.getTileWidth(),
    ...
    if (!bTrading) {
      ...
      for (int i = 0; i < tradePanel.getAlButtonPointsCaravan().size(); i++) {
        ...
        if (menu.getItems().get(iIndex).getIcon() != null
          ...
          drawTile(
              menu.getItems().get(iIndex).getIcon(),
              point,
              TRADE_PANEL_BUTTON_WIDTH,
    ...
    if (!bTrading) {
      ...
      for (int i = 0; i < tradePanel.getAlButtonPointsCaravan().size(); i++) {
        ...
        UtilsGL.drawStringWithBorder(
            sText,
            point.x + TRADE_PANEL_BUTTON_WIDTH / 2 - iTextWidth / 2,
            point.y + TRADE_PANEL_BUTTON_HEIGHT - UtilFont.MAX_HEIGHT,
            ColorGL.WHITE,
            ColorGL.BLACK);
    ...
    UtilsGL.drawString(
        sText,
        tradePanel.getCaravanCoinsIconPoint().x
            + TradePanel.tileTradeCaravanCoins.getTileWidth() / 2
            - UtilFont.getWidth(sText) / 2,
    ...
    UtilsGL.drawString(
        sText,
        tradePanel.getCostPoint().x
            + TradePanel.tileTradeCost.getTileWidth() / 2
            - UtilFont.getWidth(sText) / 2,
    ...
    UtilsGL.drawString(
        sText,
        tradePanel.getTownCoinsIconPoint().x
            + TradePanel.tileTradeTownCoins.getTileWidth() / 2
            - UtilFont.getWidth(sText) / 2,
        tradePanel.getTownCoinsIconPoint().y + TradePanel.tileTradeTownCoins.getTileHeight(),
        ColorGL.BLACK);
  ...
  private void renderTutorialButton(int mousePanel, boolean bCheckBlink) {
    ...
    if (bCheckBlink) {
      if (imagesPanel == null
          || (ImagesPanel.getCurrentFlowIndex() == 0 && !ImagesPanel.isVisible())) {
        UtilsGL.setColorRed();
      }
    }
    drawTile(
