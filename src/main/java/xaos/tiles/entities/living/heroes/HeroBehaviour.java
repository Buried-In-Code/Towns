...
public class HeroBehaviour implements Externalizable {
  ...
  public static final int BEHAVIOUR_ID_NONE = 0;
  public static final int BEHAVIOUR_ID_IDLE = 1;
  public static final int BEHAVIOUR_ID_EXPLORE = 2;
   ...
   *            ID actual
   * @param behaviour
   *            Behacviour data del héroe, para buscar el siguiente con PCT > 0
